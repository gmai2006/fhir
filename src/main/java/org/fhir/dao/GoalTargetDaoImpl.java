...
public class GoalTargetDaoImpl implements GoalTargetDao {
  ...
  @Inject
  public GoalTargetDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public GoalTarget find(String id) {
    ...
    GoalTargetModel model = em.find(GoalTargetModel.class, id);
  ...
  public void delete(GoalTarget e) {
      final EntityManager em = entityManagerProvider.get();
      final GoalTargetModel removed = em.find(GoalTargetModel.class, e.getId());
      em.remove(removed);
  }
}