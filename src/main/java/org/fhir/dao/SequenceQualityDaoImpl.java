...
public class SequenceQualityDaoImpl implements SequenceQualityDao {
  ...
  @Inject
  public SequenceQualityDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public SequenceQuality find(String id) {
    ...
    SequenceQualityModel model = em.find(SequenceQualityModel.class, id);
  ...
  public void delete(SequenceQuality e) {
      final EntityManager em = entityManagerProvider.get();
      final SequenceQualityModel removed = em.find(SequenceQualityModel.class, e.getId());
      em.remove(removed);
  }
}