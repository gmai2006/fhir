...
public class PatientAnimalDaoImpl implements PatientAnimalDao {
  ...
  @Inject
  public PatientAnimalDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public PatientAnimal find(String id) {
    ...
    PatientAnimalModel model = em.find(PatientAnimalModel.class, id);
  ...
  public void delete(PatientAnimal e) {
      final EntityManager em = entityManagerProvider.get();
      final PatientAnimalModel removed = em.find(PatientAnimalModel.class, e.getId());
      em.remove(removed);
  }
}