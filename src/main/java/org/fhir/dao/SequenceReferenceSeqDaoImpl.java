...
public class SequenceReferenceSeqDaoImpl implements SequenceReferenceSeqDao {
  ...
  @Inject
  public SequenceReferenceSeqDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public SequenceReferenceSeq find(String id) {
    ...
    SequenceReferenceSeqModel model = em.find(SequenceReferenceSeqModel.class, id);
  ...
  public void delete(SequenceReferenceSeq e) {
      final EntityManager em = entityManagerProvider.get();
      final SequenceReferenceSeqModel removed = em.find(SequenceReferenceSeqModel.class, e.getId());
      em.remove(removed);
  }
}