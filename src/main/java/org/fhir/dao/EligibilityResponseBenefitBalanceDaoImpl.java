...
public class EligibilityResponseBenefitBalanceDaoImpl implements EligibilityResponseBenefitBalanceDao {
  ...
  @Inject
  public EligibilityResponseBenefitBalanceDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public EligibilityResponseBenefitBalance find(String id) {
    ...
    EligibilityResponseBenefitBalanceModel model = em.find(EligibilityResponseBenefitBalanceModel.class, id);
  ...
  public void delete(EligibilityResponseBenefitBalance e) {
      final EntityManager em = entityManagerProvider.get();
      final EligibilityResponseBenefitBalanceModel removed = em.find(EligibilityResponseBenefitBalanceModel.class, e.getId());
      em.remove(removed);
  }
}