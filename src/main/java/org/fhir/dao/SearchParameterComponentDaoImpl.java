...
public class SearchParameterComponentDaoImpl implements SearchParameterComponentDao {
  ...
  @Inject
  public SearchParameterComponentDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public SearchParameterComponent find(String id) {
    ...
    SearchParameterComponentModel model = em.find(SearchParameterComponentModel.class, id);
  ...
  public void delete(SearchParameterComponent e) {
      final EntityManager em = entityManagerProvider.get();
      final SearchParameterComponentModel removed = em.find(SearchParameterComponentModel.class, e.getId());
      em.remove(removed);
  }
}