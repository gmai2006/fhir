...
public class ClaimProcedureDaoImpl implements ClaimProcedureDao {
  ...
  @Inject
  public ClaimProcedureDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ClaimProcedure find(String id) {
    ...
    ClaimProcedureModel model = em.find(ClaimProcedureModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(ClaimProcedure e) {
      final EntityManager em = entityManagerProvider.get();
      final ClaimProcedureModel removed = em.find(ClaimProcedureModel.class, e.getId());
      em.remove(removed);
  }
}