...
public class EncounterStatusHistoryDaoImpl implements EncounterStatusHistoryDao {
  ...
  @Inject
  public EncounterStatusHistoryDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public EncounterStatusHistory find(String id) {
    ...
    EncounterStatusHistoryModel model = em.find(EncounterStatusHistoryModel.class, id);
  ...
  public void delete(EncounterStatusHistory e) {
      final EntityManager em = entityManagerProvider.get();
      final EncounterStatusHistoryModel removed = em.find(EncounterStatusHistoryModel.class, e.getId());
      em.remove(removed);
  }
}