...
public class CarePlanDetailDaoImpl implements CarePlanDetailDao {
  ...
  @Inject
  public CarePlanDetailDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public CarePlanDetail find(String id) {
    ...
    CarePlanDetailModel model = em.find(CarePlanDetailModel.class, id);
  ...
  public void delete(CarePlanDetail e) {
      final EntityManager em = entityManagerProvider.get();
      final CarePlanDetailModel removed = em.find(CarePlanDetailModel.class, e.getId());
      em.remove(removed);
  }
}