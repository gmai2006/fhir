...
public class DataElementMappingDaoImpl implements DataElementMappingDao {
  ...
  @Inject
  public DataElementMappingDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public DataElementMapping find(String id) {
    ...
    DataElementMappingModel model = em.find(DataElementMappingModel.class, id);
  ...
  public void delete(DataElementMapping e) {
      final EntityManager em = entityManagerProvider.get();
      final DataElementMappingModel removed = em.find(DataElementMappingModel.class, e.getId());
      em.remove(removed);
  }
}