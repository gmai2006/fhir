...
public class MetaDaoImpl implements MetaDao {
  ...
  @Inject
  public MetaDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public Meta find(String id) {
    ...
    MetaModel model = em.find(MetaModel.class, id);
  ...
  public void delete(Meta e) {
      final EntityManager em = entityManagerProvider.get();
      final MetaModel removed = em.find(MetaModel.class, e.getId());
      em.remove(removed);
  }
}