...
public class PlanDefinitionConditionDaoImpl implements PlanDefinitionConditionDao {
  ...
  @Inject
  public PlanDefinitionConditionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public PlanDefinitionCondition find(String id) {
    ...
    PlanDefinitionConditionModel model = em.find(PlanDefinitionConditionModel.class, id);
  ...
  public void delete(PlanDefinitionCondition e) {
      final EntityManager em = entityManagerProvider.get();
      final PlanDefinitionConditionModel removed = em.find(PlanDefinitionConditionModel.class, e.getId());
      em.remove(removed);
  }
}