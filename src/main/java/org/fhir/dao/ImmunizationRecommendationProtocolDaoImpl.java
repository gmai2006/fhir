...
public class ImmunizationRecommendationProtocolDaoImpl implements ImmunizationRecommendationProtocolDao {
  ...
  @Inject
  public ImmunizationRecommendationProtocolDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ImmunizationRecommendationProtocol find(String id) {
    ...
    ImmunizationRecommendationProtocolModel model = em.find(ImmunizationRecommendationProtocolModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(ImmunizationRecommendationProtocol e) {
      final EntityManager em = entityManagerProvider.get();
      final ImmunizationRecommendationProtocolModel removed = em.find(ImmunizationRecommendationProtocolModel.class, e.getId());
      em.remove(removed);
  }
}