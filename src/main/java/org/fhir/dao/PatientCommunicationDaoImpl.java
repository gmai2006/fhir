...
public class PatientCommunicationDaoImpl implements PatientCommunicationDao {
  ...
  @Inject
  public PatientCommunicationDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public PatientCommunication find(String id) {
    ...
    PatientCommunicationModel model = em.find(PatientCommunicationModel.class, id);
  ...
  public void delete(PatientCommunication e) {
      final EntityManager em = entityManagerProvider.get();
      final PatientCommunicationModel removed = em.find(PatientCommunicationModel.class, e.getId());
      em.remove(removed);
  }
}