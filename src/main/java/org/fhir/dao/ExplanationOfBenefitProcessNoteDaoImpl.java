...
public class ExplanationOfBenefitProcessNoteDaoImpl implements ExplanationOfBenefitProcessNoteDao {
  ...
  @Inject
  public ExplanationOfBenefitProcessNoteDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ExplanationOfBenefitProcessNote find(String id) {
    ...
    ExplanationOfBenefitProcessNoteModel model = em.find(ExplanationOfBenefitProcessNoteModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(ExplanationOfBenefitProcessNote e) {
      final EntityManager em = entityManagerProvider.get();
      final ExplanationOfBenefitProcessNoteModel removed = em.find(ExplanationOfBenefitProcessNoteModel.class, e.getId());
      em.remove(removed);
  }
}