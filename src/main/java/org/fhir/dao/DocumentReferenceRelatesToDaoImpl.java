...
public class DocumentReferenceRelatesToDaoImpl implements DocumentReferenceRelatesToDao {
  ...
  @Inject
  public DocumentReferenceRelatesToDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public DocumentReferenceRelatesTo find(String id) {
    ...
    DocumentReferenceRelatesToModel model = em.find(DocumentReferenceRelatesToModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(DocumentReferenceRelatesTo e) {
      final EntityManager em = entityManagerProvider.get();
      final DocumentReferenceRelatesToModel removed = em.find(DocumentReferenceRelatesToModel.class, e.getId());
      em.remove(removed);
  }
}