...
public class ImmunizationReactionDaoImpl implements ImmunizationReactionDao {
  ...
  @Inject
  public ImmunizationReactionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ImmunizationReaction find(String id) {
    ...
    ImmunizationReactionModel model = em.find(ImmunizationReactionModel.class, id);
  ...
  public void delete(ImmunizationReaction e) {
      final EntityManager em = entityManagerProvider.get();
      final ImmunizationReactionModel removed = em.find(ImmunizationReactionModel.class, e.getId());
      em.remove(removed);
  }
}