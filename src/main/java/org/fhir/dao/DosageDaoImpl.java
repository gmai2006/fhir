...
public class DosageDaoImpl implements DosageDao {
  ...
  @Inject
  public DosageDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public Dosage find(String id) {
    ...
    DosageModel model = em.find(DosageModel.class, id);
  ...
  public void delete(Dosage e) {
      final EntityManager em = entityManagerProvider.get();
      final DosageModel removed = em.find(DosageModel.class, e.getId());
      em.remove(removed);
  }
}