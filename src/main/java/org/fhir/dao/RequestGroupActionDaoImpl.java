...
public class RequestGroupActionDaoImpl implements RequestGroupActionDao {
  ...
  @Inject
  public RequestGroupActionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public RequestGroupAction find(String id) {
    ...
    RequestGroupActionModel model = em.find(RequestGroupActionModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(RequestGroupAction e) {
      final EntityManager em = entityManagerProvider.get();
      final RequestGroupActionModel removed = em.find(RequestGroupActionModel.class, e.getId());
      em.remove(removed);
  }
}