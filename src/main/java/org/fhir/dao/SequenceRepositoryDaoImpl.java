...
public class SequenceRepositoryDaoImpl implements SequenceRepositoryDao {
  ...
  @Inject
  public SequenceRepositoryDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public SequenceRepository find(String id) {
    ...
    SequenceRepositoryModel model = em.find(SequenceRepositoryModel.class, id);
  ...
  public void delete(SequenceRepository e) {
      final EntityManager em = entityManagerProvider.get();
      final SequenceRepositoryModel removed = em.find(SequenceRepositoryModel.class, e.getId());
      em.remove(removed);
  }
}