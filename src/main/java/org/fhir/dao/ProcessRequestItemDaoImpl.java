...
public class ProcessRequestItemDaoImpl implements ProcessRequestItemDao {
  ...
  @Inject
  public ProcessRequestItemDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ProcessRequestItem find(String id) {
    ...
    ProcessRequestItemModel model = em.find(ProcessRequestItemModel.class, id);
  ...
  public void delete(ProcessRequestItem e) {
      final EntityManager em = entityManagerProvider.get();
      final ProcessRequestItemModel removed = em.find(ProcessRequestItemModel.class, e.getId());
      em.remove(removed);
  }
}