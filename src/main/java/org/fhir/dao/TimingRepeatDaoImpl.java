...
public class TimingRepeatDaoImpl implements TimingRepeatDao {
  ...
  @Inject
  public TimingRepeatDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public TimingRepeat find(String id) {
    ...
    TimingRepeatModel model = em.find(TimingRepeatModel.class, id);
  ...
  public void delete(TimingRepeat e) {
      final EntityManager em = entityManagerProvider.get();
      final TimingRepeatModel removed = em.find(TimingRepeatModel.class, e.getId());
      em.remove(removed);
  }
}