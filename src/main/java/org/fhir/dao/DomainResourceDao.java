...
public interface DomainResourceDao {
  public DomainResource find(String id);

  public List<DomainResource> select(int maxResult);

  public List<DomainResource> selectAll();
  public DomainResource create(DomainResource e);

  public DomainResource update(DomainResource e);
  public void delete(DomainResource e);
