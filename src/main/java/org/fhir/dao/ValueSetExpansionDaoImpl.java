...
public class ValueSetExpansionDaoImpl implements ValueSetExpansionDao {
  ...
  @Inject
  public ValueSetExpansionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ValueSetExpansion find(String id) {
    ...
    ValueSetExpansionModel model = em.find(ValueSetExpansionModel.class, id);
  ...
  public void delete(ValueSetExpansion e) {
      final EntityManager em = entityManagerProvider.get();
      final ValueSetExpansionModel removed = em.find(ValueSetExpansionModel.class, e.getId());
      em.remove(removed);
  }
}