...
public class ClinicalImpressionInvestigationDaoImpl implements ClinicalImpressionInvestigationDao {
  ...
  @Inject
  public ClinicalImpressionInvestigationDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ClinicalImpressionInvestigation find(String id) {
    ...
    ClinicalImpressionInvestigationModel model = em.find(ClinicalImpressionInvestigationModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(ClinicalImpressionInvestigation e) {
      final EntityManager em = entityManagerProvider.get();
      final ClinicalImpressionInvestigationModel removed = em.find(ClinicalImpressionInvestigationModel.class, e.getId());
      em.remove(removed);
  }
}