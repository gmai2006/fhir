...
public class MediaDaoImpl implements MediaDao {
  ...
  @Inject
  public MediaDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public Media find(String id) {
    ...
    MediaModel model = em.find(MediaModel.class, id);
  ...
  public List<Media> findByOperator(QueryBuilder queryBuilder) {
  	final EntityManager em = entityManagerProvider.get();
  	final String queryStr = "select a from MediaModel a, Reference b where a.operator_id=b.parent_id " + queryBuilder.getWhereClause();
    return findByQuery(queryBuilder, queryStr);
  }
  @Override
  ...
  public List<Media> findByField(QueryBuilder queryBuilder) {
  	final EntityManager em = entityManagerProvider.get();
  	final String queryStr = "select a from MediaModel a " + queryBuilder.getWhereClause();
    return findByQuery(queryBuilder, queryStr);
  }

  private List<Media> findByQuery(QueryBuilder queryBuilder, String queryStr) {
  	final EntityManager em = entityManagerProvider.get();
    Query query = em.createQuery(queryStr, MediaModel.class);
