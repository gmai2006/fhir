...
public class PatientContactDaoImpl implements PatientContactDao {
  ...
  @Inject
  public PatientContactDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public PatientContact find(String id) {
    ...
    PatientContactModel model = em.find(PatientContactModel.class, id);
  ...
  public void delete(PatientContact e) {
      final EntityManager em = entityManagerProvider.get();
      final PatientContactModel removed = em.find(PatientContactModel.class, e.getId());
      em.remove(removed);
  }
}