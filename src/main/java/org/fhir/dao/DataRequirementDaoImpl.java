...
public class DataRequirementDaoImpl implements DataRequirementDao {
  ...
  @Inject
  public DataRequirementDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public DataRequirement find(String id) {
    ...
    DataRequirementModel model = em.find(DataRequirementModel.class, id);
  ...
  public void delete(DataRequirement e) {
      final EntityManager em = entityManagerProvider.get();
      final DataRequirementModel removed = em.find(DataRequirementModel.class, e.getId());
      em.remove(removed);
  }
}