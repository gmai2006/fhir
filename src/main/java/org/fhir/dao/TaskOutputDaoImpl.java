...
public class TaskOutputDaoImpl implements TaskOutputDao {
  ...
  @Inject
  public TaskOutputDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public TaskOutput find(String id) {
    ...
    TaskOutputModel model = em.find(TaskOutputModel.class, id);
  ...
  public void delete(TaskOutput e) {
      final EntityManager em = entityManagerProvider.get();
      final TaskOutputModel removed = em.find(TaskOutputModel.class, e.getId());
      em.remove(removed);
  }
}