...
public class NamingSystemUniqueIdDaoImpl implements NamingSystemUniqueIdDao {
  ...
  @Inject
  public NamingSystemUniqueIdDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public NamingSystemUniqueId find(String id) {
    ...
    NamingSystemUniqueIdModel model = em.find(NamingSystemUniqueIdModel.class, id);
  ...
  public void delete(NamingSystemUniqueId e) {
      final EntityManager em = entityManagerProvider.get();
      final NamingSystemUniqueIdModel removed = em.find(NamingSystemUniqueIdModel.class, e.getId());
      em.remove(removed);
  }
}