...
public class QuestionnaireOptionDaoImpl implements QuestionnaireOptionDao {
  ...
  @Inject
  public QuestionnaireOptionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public QuestionnaireOption find(String id) {
    ...
    QuestionnaireOptionModel model = em.find(QuestionnaireOptionModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(QuestionnaireOption e) {
      final EntityManager em = entityManagerProvider.get();
      final QuestionnaireOptionModel removed = em.find(QuestionnaireOptionModel.class, e.getId());
      em.remove(removed);
  }
}