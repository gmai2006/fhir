...
public class ExpansionProfileFixedVersionDaoImpl implements ExpansionProfileFixedVersionDao {
  ...
  @Inject
  public ExpansionProfileFixedVersionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ExpansionProfileFixedVersion find(String id) {
    ...
    ExpansionProfileFixedVersionModel model = em.find(ExpansionProfileFixedVersionModel.class, id);
  ...
  public void delete(ExpansionProfileFixedVersion e) {
      final EntityManager em = entityManagerProvider.get();
      final ExpansionProfileFixedVersionModel removed = em.find(ExpansionProfileFixedVersionModel.class, e.getId());
      em.remove(removed);
  }
}