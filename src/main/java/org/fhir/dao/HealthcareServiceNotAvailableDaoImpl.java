...
public class HealthcareServiceNotAvailableDaoImpl implements HealthcareServiceNotAvailableDao {
  ...
  @Inject
  public HealthcareServiceNotAvailableDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public HealthcareServiceNotAvailable find(String id) {
    ...
    HealthcareServiceNotAvailableModel model = em.find(HealthcareServiceNotAvailableModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(HealthcareServiceNotAvailable e) {
      final EntityManager em = entityManagerProvider.get();
      final HealthcareServiceNotAvailableModel removed = em.find(HealthcareServiceNotAvailableModel.class, e.getId());
      em.remove(removed);
  }
}