...
public class CapabilityStatementSoftwareDaoImpl implements CapabilityStatementSoftwareDao {
  ...
  @Inject
  public CapabilityStatementSoftwareDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public CapabilityStatementSoftware find(String id) {
    ...
    CapabilityStatementSoftwareModel model = em.find(CapabilityStatementSoftwareModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(CapabilityStatementSoftware e) {
      final EntityManager em = entityManagerProvider.get();
      final CapabilityStatementSoftwareModel removed = em.find(CapabilityStatementSoftwareModel.class, e.getId());
      em.remove(removed);
  }
}