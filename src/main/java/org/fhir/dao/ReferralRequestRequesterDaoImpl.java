...
public class ReferralRequestRequesterDaoImpl implements ReferralRequestRequesterDao {
  ...
  @Inject
  public ReferralRequestRequesterDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ReferralRequestRequester find(String id) {
    ...
    ReferralRequestRequesterModel model = em.find(ReferralRequestRequesterModel.class, id);
  ...
  public void delete(ReferralRequestRequester e) {
      final EntityManager em = entityManagerProvider.get();
      final ReferralRequestRequesterModel removed = em.find(ReferralRequestRequesterModel.class, e.getId());
      em.remove(removed);
  }
}