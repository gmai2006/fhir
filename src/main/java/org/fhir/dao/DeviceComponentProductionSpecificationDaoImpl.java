...
public class DeviceComponentProductionSpecificationDaoImpl implements DeviceComponentProductionSpecificationDao {
  ...
  @Inject
  public DeviceComponentProductionSpecificationDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public DeviceComponentProductionSpecification find(String id) {
    ...
    DeviceComponentProductionSpecificationModel model = em.find(DeviceComponentProductionSpecificationModel.class, id);
  ...
  public void delete(DeviceComponentProductionSpecification e) {
      final EntityManager em = entityManagerProvider.get();
      final DeviceComponentProductionSpecificationModel removed = em.find(DeviceComponentProductionSpecificationModel.class, e.getId());
      em.remove(removed);
  }
}