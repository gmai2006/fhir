...
public class RiskAssessmentPredictionDaoImpl implements RiskAssessmentPredictionDao {
  ...
  @Inject
  public RiskAssessmentPredictionDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public RiskAssessmentPrediction find(String id) {
    ...
    RiskAssessmentPredictionModel model = em.find(RiskAssessmentPredictionModel.class, id);
  ...
  @Override
  @Transactional
  public void delete(RiskAssessmentPrediction e) {
      final EntityManager em = entityManagerProvider.get();
      final RiskAssessmentPredictionModel removed = em.find(RiskAssessmentPredictionModel.class, e.getId());
      em.remove(removed);
  }
}