...
public class ObservationReferenceRangeDaoImpl implements ObservationReferenceRangeDao {
  ...
  @Inject
  public ObservationReferenceRangeDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ObservationReferenceRange find(String id) {
    ...
    ObservationReferenceRangeModel model = em.find(ObservationReferenceRangeModel.class, id);
  ...
  public void delete(ObservationReferenceRange e) {
      final EntityManager em = entityManagerProvider.get();
      final ObservationReferenceRangeModel removed = em.find(ObservationReferenceRangeModel.class, e.getId());
      em.remove(removed);
  }
}