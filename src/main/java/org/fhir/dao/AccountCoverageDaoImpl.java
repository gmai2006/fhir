...
public class AccountCoverageDaoImpl implements AccountCoverageDao {
  ...
  @Inject
  public AccountCoverageDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public AccountCoverage find(String id) {
    ...
    AccountCoverageModel model = em.find(AccountCoverageModel.class, id);
  ...
  public void delete(AccountCoverage e) {
      final EntityManager em = entityManagerProvider.get();
      final AccountCoverageModel removed = em.find(AccountCoverageModel.class, e.getId());
      em.remove(removed);
  }
}