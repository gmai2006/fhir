...
public class ClaimPayeeDaoImpl implements ClaimPayeeDao {
  ...
  @Inject
  public ClaimPayeeDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public ClaimPayee find(String id) {
    ...
    ClaimPayeeModel model = em.find(ClaimPayeeModel.class, id);
  ...
  public void delete(ClaimPayee e) {
      final EntityManager em = entityManagerProvider.get();
      final ClaimPayeeModel removed = em.find(ClaimPayeeModel.class, e.getId());
      em.remove(removed);
  }
}