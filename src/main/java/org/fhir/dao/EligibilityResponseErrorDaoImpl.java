...
public class EligibilityResponseErrorDaoImpl implements EligibilityResponseErrorDao {
  ...
  @Inject
  public EligibilityResponseErrorDaoImpl (final Provider<EntityManager> entityManagerProvider) {
  ...
  public EligibilityResponseError find(String id) {
    ...
    EligibilityResponseErrorModel model = em.find(EligibilityResponseErrorModel.class, id);
  ...
  public void delete(EligibilityResponseError e) {
      final EntityManager em = entityManagerProvider.get();
      final EligibilityResponseErrorModel removed = em.find(EligibilityResponseErrorModel.class, e.getId());
      em.remove(removed);
  }
}