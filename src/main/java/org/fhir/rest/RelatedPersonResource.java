...
public class RelatedPersonResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public RelatedPerson createOrUpdate(RelatedPerson obj) {
	...
	/**
	 * InIdempotent method
   * Update existing RelatedPerson
   * @param obj - instance of RelatedPerson
   ...
   */
	...
	/**
   * Get RelatedPerson by its ID
   * @param id - instance of RelatedPerson
   * @return RelatedPerson
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	RelatedPerson result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all RelatedPerson with limit of returned records
   * @param max - number of records
   * @return a list RelatedPerson
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<RelatedPerson> result = service.select(input);
  ...
  /**
   * Query RelatedPerson based on basic field names
  ...
  /**
   * Query RelatedPerson by composite fields
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<RelatedPerson> result = this.service.findByPatient(new QueryBuilder(params));
