...
public class SubscriptionResource {
  ...
  @GET
  public Subscription findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Subscription> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Subscription> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Subscription> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Subscription> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Subscription> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<Subscription> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Subscription> contact(@QueryParam("contact")String contact) {
  	java.util.Map<String, String> params = QueryParser.parse(contact, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<Subscription> criteria(@QueryParam("criteria")String criteria) {
  	java.util.Map<String, String> params = QueryParser.parse(criteria, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<Subscription> addtag(@QueryParam("addtag")String addtag) {
  	java.util.Map<String, String> params = QueryParser.parse(addtag, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "addtag|contact|criteria|payload|status|type|url";
}