...
public class CodeSystemResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public CodeSystem createOrUpdate(CodeSystem obj) {
   ...
   * @param obj - instance of CodeSystem
   * @return CodeSystem
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get CodeSystem by its ID
   * @param id - instance of CodeSystem
   * @return CodeSystem
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	CodeSystem result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all CodeSystem with limit of returned records
   * @param max - number of records
   * @return a list CodeSystem
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<CodeSystem> result = service.select(input);
  ...
  /**
   * Query CodeSystem based on basic field names
   * @param UriInfo - UriInfo
   * @return list of CodeSystem
   */
  @GET
  ...
  /**
   * Query CodeSystem by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CodeSystem> result = this.service.findByJurisdiction(new QueryBuilder(params));
