...
public class MeasureResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Measure createOrUpdate(Measure obj) {
   ...
   */
	...
	/**
   * Get Measure by its ID
   * @param id - instance of Measure
   * @return Measure
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Measure result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Measure with limit of returned records
   * @param max - number of records
   * @return a list Measure
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Measure> result = service.select(input);
  ...
  /**
   * Query Measure based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.MEASURE_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Measure by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Measure> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response topic(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Measure> result = this.service.findByTopic(new QueryBuilder(params));
