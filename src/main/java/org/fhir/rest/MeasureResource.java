...
public class MeasureResource {
  ...
  @GET
  public Measure findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Measure> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Measure> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Measure> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Measure> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Measure> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<Measure> url(@QueryParam("url")String url) {
  ...
  */
  @GET
  public List<Measure> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Measure> version(@QueryParam("version")String version) {
  ...
  */
  @GET
  public List<Measure> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<Measure> title(@QueryParam("title")String title) {
  ...
  */
  @GET
  public List<Measure> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Measure> publisher(@QueryParam("publisher")String publisher) {
  ...
  */
  @GET
  public List<Measure> description(@QueryParam("description")String description) {
  ...
  */
  @GET
  public List<Measure> effective(@QueryParam("effective")String effective) {
  ...
  */
  @GET
  public List<Measure> jurisdiction(@QueryParam("jurisdiction")String jurisdiction) {
  ...
  */
  @GET
  public List<Measure> topic(@QueryParam("topic")String topic) {
