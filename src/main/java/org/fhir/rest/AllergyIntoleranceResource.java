...
public class AllergyIntoleranceResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public AllergyIntolerance createOrUpdate(AllergyIntolerance obj) {
	...
	/**
	 * InIdempotent method
   * Update existing AllergyIntolerance
   * @param obj - instance of AllergyIntolerance
   ...
   */
	...
	/**
   * Delete existing AllergyIntolerance
   * @param obj - instance of AllergyIntolerance
   * @return AllergyIntolerance
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get AllergyIntolerance by its ID
   * @param id - instance of AllergyIntolerance
   * @return AllergyIntolerance
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	AllergyIntolerance result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all AllergyIntolerance with limit of returned records
   * @param max - number of records
   * @return a list AllergyIntolerance
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<AllergyIntolerance> result = service.select(input);
  ...
  /**
   * Query AllergyIntolerance based on basic field names
   * @param UriInfo - UriInfo
   * @return list of AllergyIntolerance
   */
  @GET
  ...
  /**
   * Query AllergyIntolerance by composite fields
  ...
  */
  ...
  public Response recorder(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<AllergyIntolerance> result = this.service.findByRecorder(new QueryBuilder(params));
