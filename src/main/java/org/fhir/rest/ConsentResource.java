...
public class ConsentResource {
  ...
  @GET
  public Consent findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Consent> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Consent> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Consent> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Consent> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Consent> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("consentor")
  public List<Consent> consentor(@QueryParam("consentor")String consentor) {
  	java.util.Map<String, String> params = QueryParser.parse(consentor, VALID_FIELDS);
  	return this.service.findByConsentingParty(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  @Path("organization")
  public List<Consent> organization(@QueryParam("organization")String organization) {
  ...
  */
  @GET
  public List<Consent> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Consent> category(@QueryParam("category")String category) {
  ...
  */
  @GET
  public List<Consent> period(@QueryParam("period")String period) {
