...
public class FHIRListResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public FHIRList createOrUpdate(FHIRList obj) {
	...
	/**
	 * InIdempotent method
   * Update existing FHIRList
   * @param obj - instance of FHIRList
   * @return FHIRList
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get FHIRList by its ID
   * @param id - instance of FHIRList
   * @return FHIRList
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	FHIRList result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all FHIRList with limit of returned records
   * @param max - number of records
   * @return a list FHIRList
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<FHIRList> result = service.select(input);
  ...
  /**
   * Query FHIRList based on basic field names
   * @param UriInfo - UriInfo
   * @return list of FHIRList
   */
  @GET
