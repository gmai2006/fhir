...
public class DiagnosticReportResource {
  ...
  public Response find(@PathParam("id") String id) {
  	DiagnosticReport result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DiagnosticReport> result = service.select(input);
  ...
  */
  ...
  public Response category(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findByCategory(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findByContext(new QueryBuilder(params));
  ...
  */
  ...
  public Response specimen(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findBySpecimen(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("result")
  public Response result(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findByResult(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("diagnosis")
  public Response diagnosis(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DiagnosticReport> result = this.service.findByCodedDiagnosis(new QueryBuilder(params));
