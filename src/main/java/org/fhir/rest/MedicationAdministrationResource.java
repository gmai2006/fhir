...
public class MedicationAdministrationResource {
  ...
  @GET
  public MedicationAdministration findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<MedicationAdministration> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<MedicationAdministration> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationAdministration> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationAdministration> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationAdministration> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<MedicationAdministration> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("device")
  public List<MedicationAdministration> device(@QueryParam("device")String device) {
  ...
  */
  @GET
  public List<MedicationAdministration> notgiven(@QueryParam("notgiven")String notgiven) {
  ...
  */
  @GET
  public List<MedicationAdministration> reasonnotgiven(@QueryParam("reasonnotgiven")String reasonnotgiven) {
  	java.util.Map<String, String> params = QueryParser.parse(reasonnotgiven, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<MedicationAdministration> reasongiven(@QueryParam("reasongiven")String reasongiven) {
  	java.util.Map<String, String> params = QueryParser.parse(reasongiven, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
