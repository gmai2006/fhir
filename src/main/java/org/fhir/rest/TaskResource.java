...
public class TaskResource {
  ...
  public Response find(@PathParam("id") String id) {
  	Task result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Task> result = service.select(input);
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.TASK_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  */
  ...
  public Response basedon(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByBasedOn(new QueryBuilder(params));
  ...
  */
  ...
  public Response partof(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByPartOf(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("businessstatus")
  public Response businessstatus(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByBusinessStatus(new QueryBuilder(params));
  ...
  */
  ...
  public Response code(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByCode(new QueryBuilder(params));
  ...
  */
  ...
  public Response focus(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByFocus(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByContext(new QueryBuilder(params));
  ...
  */
  ...
  public Response performer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByPerformerType(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("owner")
  public Response owner(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Task> result = this.service.findByOwner(new QueryBuilder(params));
