...
public class GraphDefinitionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public GraphDefinition createOrUpdate(GraphDefinition obj) {
   ...
   * @param obj - instance of GraphDefinition
   ...
   */
	...
	/**
   * Delete existing GraphDefinition
   * @param obj - instance of GraphDefinition
   * @return GraphDefinition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get GraphDefinition by its ID
   * @param id - instance of GraphDefinition
   * @return GraphDefinition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	GraphDefinition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all GraphDefinition with limit of returned records
   * @param max - number of records
   * @return a list GraphDefinition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<GraphDefinition> result = service.select(input);
  ...
  /**
   * Query GraphDefinition based on basic field names
   * @param UriInfo - UriInfo
   * @return list of GraphDefinition
   */
  @GET
  ...
  /**
   * Query GraphDefinition by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<GraphDefinition> result = this.service.findByJurisdiction(new QueryBuilder(params));
