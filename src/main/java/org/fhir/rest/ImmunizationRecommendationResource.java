...
public class ImmunizationRecommendationResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ImmunizationRecommendation createOrUpdate(ImmunizationRecommendation obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ImmunizationRecommendation
   * @param obj - instance of ImmunizationRecommendation
   ...
   */
	...
	/**
   * Delete existing ImmunizationRecommendation
   * @param obj - instance of ImmunizationRecommendation
   * @return ImmunizationRecommendation
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ImmunizationRecommendation by its ID
   * @param id - instance of ImmunizationRecommendation
   * @return ImmunizationRecommendation
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ImmunizationRecommendation result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ImmunizationRecommendation with limit of returned records
   * @param max - number of records
   * @return a list ImmunizationRecommendation
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ImmunizationRecommendation> result = service.select(input);
  ...
  /**
   * Query ImmunizationRecommendation based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ImmunizationRecommendation
   */
  @GET
  public Response findByField(@Context UriInfo info) {
  	...
  	List<ImmunizationRecommendation> result = null;

  	if (FhirConstant.META_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  		result = this.service.findByMeta(new QueryBuilder(params));
  	}
  	else if (FhirConstant.IMMUNIZATIONRECOMMENDATION_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query ImmunizationRecommendation by composite fields
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ImmunizationRecommendation> result = this.service.findByPatient(new QueryBuilder(params));
