...
public class ImmunizationRecommendationResource {
  ...
  @GET
  public ImmunizationRecommendation findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<ImmunizationRecommendation> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<ImmunizationRecommendation> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImmunizationRecommendation> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImmunizationRecommendation> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImmunizationRecommendation> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<ImmunizationRecommendation> patient(@QueryParam("patient")String patient) {
  ...
  private static final String VALID_FIELDS = "date|dosenumber|dosesequence|identifier|information|patient|status|support|targetdisease|vaccinetype";
}