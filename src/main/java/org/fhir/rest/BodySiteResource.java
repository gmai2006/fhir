...
import org.fhir.service.BodySiteService;
 ...
 */
public class BodySiteResource {
  private final Logger logger = Logger.getLogger(this.getClass().getName());
  private final BodySiteService service;

  @Inject
  public BodySiteResource(final BodySiteService service) {
  ...
  @GET
  @Path("{id}")
  public BodySite find(@PathParam("id") String id) {
  	return this.service.find(id);
  }

  @GET
  public BodySite findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<BodySite> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<BodySite> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<BodySite> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<BodySite> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<BodySite> findByText(@QueryParam("_text") String _text) {
  ...
  @GET
  public List<BodySite> findAll() {
  	return this.service.selectAll();
  }

  @GET
  @Path("select/{max}")
  public List<BodySite> findWithLimit(@PathParam("max") String max) {
  	Integer input = null;
  	try {
  ...
  */
  @GET
  @Path("patient")
  public List<BodySite> patient(@QueryParam("patient")String patient) {
  ...
  /**
  * Descr: Identifier for this instance of the anatomical location
  * Type: token
  */
  @GET
  public List<BodySite> identifier(@QueryParam("identifier")String identifier) {
  	java.util.Map<String, String> params = QueryParser.parse(identifier, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "code|identifier|patient";
}