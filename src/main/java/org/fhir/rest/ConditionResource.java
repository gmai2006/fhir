...
public class ConditionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Condition createOrUpdate(Condition obj) {
   ...
   * @param obj - instance of Condition
   * @return Condition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   * @param id - instance of Condition
   * @return Condition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Condition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Condition with limit of returned records
   * @param max - number of records
   * @return a list Condition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Condition> result = service.select(input);
  ...
  /**
   * Query Condition based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.CONDITION_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Condition by composite fields
  ...
  */
  ...
  public Response category(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findByCategory(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("severity")
  public Response severity(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findBySeverity(new QueryBuilder(params));
  ...
  */
  ...
  public Response bodysite(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findByBodySite(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findByContext(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("asserter")
  public Response asserter(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Condition> result = this.service.findByAsserter(new QueryBuilder(params));
