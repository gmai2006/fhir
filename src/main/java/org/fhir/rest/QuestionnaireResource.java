...
public class QuestionnaireResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Questionnaire createOrUpdate(Questionnaire obj) {
   ...
   * @param obj - instance of Questionnaire
   ...
   * @param id - instance of Questionnaire
   * @return Questionnaire
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Questionnaire result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Questionnaire with limit of returned records
   * @param max - number of records
   * @return a list Questionnaire
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Questionnaire> result = service.select(input);
  ...
  /**
   * Query Questionnaire based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.QUESTIONNAIRE_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Questionnaire by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Questionnaire> result = this.service.findByJurisdiction(new QueryBuilder(params));
