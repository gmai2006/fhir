...
public class ClinicalImpressionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ClinicalImpression createOrUpdate(ClinicalImpression obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ClinicalImpression
   * @param obj - instance of ClinicalImpression
   ...
   */
	...
	/**
   * Delete existing ClinicalImpression
   * @param obj - instance of ClinicalImpression
   * @return ClinicalImpression
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ClinicalImpression by its ID
   * @param id - instance of ClinicalImpression
   * @return ClinicalImpression
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ClinicalImpression result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ClinicalImpression with limit of returned records
   * @param max - number of records
   * @return a list ClinicalImpression
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ClinicalImpression> result = service.select(input);
  ...
  /**
   * Query ClinicalImpression based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ClinicalImpression
   */
  @GET
  ...
  /**
   * Query ClinicalImpression by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ClinicalImpression> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ClinicalImpression> result = this.service.findByContext(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("assessor")
  public Response assessor(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ClinicalImpression> result = this.service.findByAssessor(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("previous")
  public Response previous(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ClinicalImpression> result = this.service.findByPrevious(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("problem")
  public Response problem(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ClinicalImpression> result = this.service.findByProblem(new QueryBuilder(params));
