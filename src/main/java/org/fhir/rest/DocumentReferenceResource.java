...
public class DocumentReferenceResource {
  ...
  @GET
  public DocumentReference findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<DocumentReference> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<DocumentReference> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DocumentReference> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DocumentReference> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DocumentReference> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<DocumentReference> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("author")
  public List<DocumentReference> author(@QueryParam("author")String author) {
  ...
  */
  @GET
  @Path("custodian")
  public List<DocumentReference> custodian(@QueryParam("custodian")String custodian) {
  	java.util.Map<String, String> params = QueryParser.parse(custodian, VALID_FIELDS);
  	return this.service.findByCustodian(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<DocumentReference> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<DocumentReference> created(@QueryParam("created")String created) {
  ...
  */
  @GET
  public List<DocumentReference> indexed(@QueryParam("indexed")String indexed) {
  	java.util.Map<String, String> params = QueryParser.parse(indexed, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<DocumentReference> description(@QueryParam("description")String description) {
  ...
  */
  @GET
  public List<DocumentReference> securitylabel(@QueryParam("securitylabel")String securitylabel) {
  	java.util.Map<String, String> params = QueryParser.parse(securitylabel, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "encounter|authenticator|author|FHIRclass|created|custodian|description|event|facility|format|indexed|language|location|period|relatedid|relatedref|relatesto|relation|relationship|securitylabel|setting|status|subject";
}