...
public class DocumentReferenceResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public DocumentReference createOrUpdate(DocumentReference obj) {
   ...
   * @param obj - instance of DocumentReference
   ...
   */
	...
	/**
   * Delete existing DocumentReference
   * @param obj - instance of DocumentReference
   * @return DocumentReference
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get DocumentReference by its ID
   * @param id - instance of DocumentReference
   * @return DocumentReference
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	DocumentReference result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all DocumentReference with limit of returned records
   * @param max - number of records
   * @return a list DocumentReference
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DocumentReference> result = service.select(input);
  ...
  /**
   * Query DocumentReference based on basic field names
   * @param UriInfo - UriInfo
   * @return list of DocumentReference
   */
  @GET
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.DOCUMENTREFERENCE_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query DocumentReference by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentReference> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("author")
  public Response author(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentReference> result = this.service.findByAuthor(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("custodian")
  public Response custodian(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentReference> result = this.service.findByCustodian(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("securitylabel")
  public Response securitylabel(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentReference> result = this.service.findBySecurityLabel(new QueryBuilder(params));
