...
public class DocumentManifestResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public DocumentManifest createOrUpdate(DocumentManifest obj) {
	...
	/**
	 * InIdempotent method
   * Update existing DocumentManifest
   * @param obj - instance of DocumentManifest
   ...
   */
	...
	/**
   * Delete existing DocumentManifest
   * @param obj - instance of DocumentManifest
   * @return DocumentManifest
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get DocumentManifest by its ID
   * @param id - instance of DocumentManifest
   * @return DocumentManifest
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	DocumentManifest result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all DocumentManifest with limit of returned records
   * @param max - number of records
   * @return a list DocumentManifest
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DocumentManifest> result = service.select(input);
  ...
  /**
   * Query DocumentManifest based on basic field names
   * @param UriInfo - UriInfo
   * @return list of DocumentManifest
   */
  @GET
  ...
  /**
   * Query DocumentManifest by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentManifest> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response recipient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DocumentManifest> result = this.service.findByRecipient(new QueryBuilder(params));
