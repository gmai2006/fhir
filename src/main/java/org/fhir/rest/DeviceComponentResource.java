...
public class DeviceComponentResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public DeviceComponent createOrUpdate(DeviceComponent obj) {
	...
	/**
	 * InIdempotent method
   * Update existing DeviceComponent
   * @param obj - instance of DeviceComponent
   ...
   */
	...
	/**
   * Delete existing DeviceComponent
   * @param obj - instance of DeviceComponent
   * @return DeviceComponent
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get DeviceComponent by its ID
   * @param id - instance of DeviceComponent
   * @return DeviceComponent
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	DeviceComponent result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all DeviceComponent with limit of returned records
   * @param max - number of records
   * @return a list DeviceComponent
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DeviceComponent> result = service.select(input);
  ...
  /**
   * Query DeviceComponent based on basic field names
   * @param UriInfo - UriInfo
   * @return list of DeviceComponent
   */
  @GET
  ...
  /**
   * Query DeviceComponent by composite fields
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceComponent> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response source(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceComponent> result = this.service.findBySource(new QueryBuilder(params));
  ...
  */
  ...
  public Response parent(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceComponent> result = this.service.findByParent(new QueryBuilder(params));
