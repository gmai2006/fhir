...
public class HealthcareServiceResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public HealthcareService createOrUpdate(HealthcareService obj) {
   ...
   * @param obj - instance of HealthcareService
   ...
   */
	...
	/**
   * Delete existing HealthcareService
   * @param obj - instance of HealthcareService
   * @return HealthcareService
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get HealthcareService by its ID
   * @param id - instance of HealthcareService
   * @return HealthcareService
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	HealthcareService result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all HealthcareService with limit of returned records
   * @param max - number of records
   * @return a list HealthcareService
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<HealthcareService> result = service.select(input);
  ...
  /**
   * Query HealthcareService based on basic field names
   * @param UriInfo - UriInfo
   * @return list of HealthcareService
   */
  @GET
  ...
  /**
   * Query HealthcareService by composite fields
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByProvidedBy(new QueryBuilder(params));
  ...
  */
  ...
  public Response category(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByCategory(new QueryBuilder(params));
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response location(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByLocation(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("characteristic")
  public Response characteristic(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByCharacteristic(new QueryBuilder(params));
  ...
  */
  ...
  public Response endpoint(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<HealthcareService> result = this.service.findByEndpoint(new QueryBuilder(params));
