...
public class PractitionerRoleResource {
  ...
  public Response find(@PathParam("id") String id) {
  	PractitionerRole result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<PractitionerRole> result = service.select(input);
  ...
  */
  ...
  public Response practitioner(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByPractitioner(new QueryBuilder(params));
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByOrganization(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("role")
  public Response role(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByCode(new QueryBuilder(params));
  ...
  */
  ...
  public Response specialty(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findBySpecialty(new QueryBuilder(params));
  ...
  */
  ...
  public Response location(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByLocation(new QueryBuilder(params));
  ...
  */
  ...
  public Response service(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByHealthcareService(new QueryBuilder(params));
  ...
  */
  ...
  public Response endpoint(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PractitionerRole> result = this.service.findByEndpoint(new QueryBuilder(params));
