...
public class ImagingManifestResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ImagingManifest createOrUpdate(ImagingManifest obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ImagingManifest
   * @param obj - instance of ImagingManifest
   ...
   */
	...
	/**
   * Delete existing ImagingManifest
   * @param obj - instance of ImagingManifest
   * @return ImagingManifest
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ImagingManifest by its ID
   * @param id - instance of ImagingManifest
   * @return ImagingManifest
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ImagingManifest result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ImagingManifest with limit of returned records
   * @param max - number of records
   * @return a list ImagingManifest
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ImagingManifest> result = service.select(input);
  ...
  /**
   * Query ImagingManifest based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ImagingManifest
   */
  @GET
