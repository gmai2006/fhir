...
public class ImagingManifestResource {
  ...
  @GET
  public ImagingManifest findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<ImagingManifest> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<ImagingManifest> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingManifest> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingManifest> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingManifest> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<ImagingManifest> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<ImagingManifest> authoringtime(@QueryParam("authoringtime")String authoringtime) {
  	java.util.Map<String, String> params = QueryParser.parse(authoringtime, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "author|authoringtime|endpoint|identifier|imagingstudy|selectedstudy";
}