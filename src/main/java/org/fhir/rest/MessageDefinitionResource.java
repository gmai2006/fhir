...
public class MessageDefinitionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public MessageDefinition createOrUpdate(MessageDefinition obj) {
	...
	/**
	 * InIdempotent method
   * Update existing MessageDefinition
   * @param obj - instance of MessageDefinition
   ...
   */
	...
	/**
   * Delete existing MessageDefinition
   * @param obj - instance of MessageDefinition
   * @return MessageDefinition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get MessageDefinition by its ID
   * @param id - instance of MessageDefinition
   * @return MessageDefinition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	MessageDefinition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all MessageDefinition with limit of returned records
   * @param max - number of records
   * @return a list MessageDefinition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<MessageDefinition> result = service.select(input);
  ...
  /**
   * Query MessageDefinition based on basic field names
   * @param UriInfo - UriInfo
   * @return list of MessageDefinition
   */
  @GET
  ...
  /**
   * Query MessageDefinition by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MessageDefinition> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response event(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MessageDefinition> result = this.service.findByEvent(new QueryBuilder(params));
