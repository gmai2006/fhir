...
public class RiskAssessmentResource {
  ...
  @GET
  public RiskAssessment findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<RiskAssessment> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<RiskAssessment> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<RiskAssessment> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<RiskAssessment> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<RiskAssessment> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<RiskAssessment> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("performer")
  public List<RiskAssessment> performer(@QueryParam("performer")String performer) {
  ...
  */
  @GET
  public List<RiskAssessment> method(@QueryParam("method")String method) {
  	java.util.Map<String, String> params = QueryParser.parse(method, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "condition|method|performer|probability|risk|subject";
}