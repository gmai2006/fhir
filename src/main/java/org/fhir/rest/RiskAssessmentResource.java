...
public class RiskAssessmentResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public RiskAssessment createOrUpdate(RiskAssessment obj) {
	...
	/**
	 * InIdempotent method
   * Update existing RiskAssessment
   * @param obj - instance of RiskAssessment
   ...
   */
	...
	/**
   * Delete existing RiskAssessment
   * @param obj - instance of RiskAssessment
   * @return RiskAssessment
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get RiskAssessment by its ID
   * @param id - instance of RiskAssessment
   * @return RiskAssessment
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	RiskAssessment result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all RiskAssessment with limit of returned records
   * @param max - number of records
   * @return a list RiskAssessment
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<RiskAssessment> result = service.select(input);
  ...
  /**
   * Query RiskAssessment based on basic field names
   * @param UriInfo - UriInfo
   * @return list of RiskAssessment
   */
  @GET
  ...
  /**
   * Query RiskAssessment by composite fields
  ...
  */
  ...
  public Response method(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<RiskAssessment> result = this.service.findByMethod(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<RiskAssessment> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response performer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<RiskAssessment> result = this.service.findByPerformer(new QueryBuilder(params));
