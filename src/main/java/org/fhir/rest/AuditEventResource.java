...
public class AuditEventResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public AuditEvent createOrUpdate(AuditEvent obj) {
	...
	/**
	 * InIdempotent method
   * Update existing AuditEvent
   * @param obj - instance of AuditEvent
   * @return AuditEvent
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get AuditEvent by its ID
   * @param id - instance of AuditEvent
   * @return AuditEvent
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	AuditEvent result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all AuditEvent with limit of returned records
   * @param max - number of records
   * @return a list AuditEvent
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<AuditEvent> result = service.select(input);
  ...
  /**
   * Query AuditEvent based on basic field names
   * @param UriInfo - UriInfo
   * @return list of AuditEvent
   */
  @GET
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.AUDITEVENT_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query AuditEvent by composite fields
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<AuditEvent> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response subtype(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<AuditEvent> result = this.service.findBySubtype(new QueryBuilder(params));
