...
public class SpecimenResource {
  ...
  @GET
  public Specimen findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Specimen> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Specimen> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Specimen> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Specimen> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Specimen> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<Specimen> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("parent")
  public List<Specimen> parent(@QueryParam("parent")String parent) {
  ...
  */
  @GET
  public List<Specimen> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Specimen> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Specimen> type(@QueryParam("type")String type) {
  	java.util.Map<String, String> params = QueryParser.parse(type, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "accession|bodysite|collected|collector|container|containerid|identifier|parent|patient|status|subject|type";
}