...
public class SpecimenResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Specimen createOrUpdate(Specimen obj) {
   ...
   * @param obj - instance of Specimen
   * @return Specimen
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get Specimen by its ID
   * @param id - instance of Specimen
   * @return Specimen
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Specimen result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Specimen with limit of returned records
   * @param max - number of records
   * @return a list Specimen
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Specimen> result = service.select(input);
  ...
  /**
   * Query Specimen based on basic field names
  ...
  /**
   * Query Specimen by composite fields
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Specimen> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Specimen> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response parent(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Specimen> result = this.service.findByParent(new QueryBuilder(params));
