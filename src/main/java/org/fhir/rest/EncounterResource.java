...
public class EncounterResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Encounter createOrUpdate(Encounter obj) {
   ...
   * @param obj - instance of Encounter
   * @return Encounter
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get Encounter by its ID
   * @param id - instance of Encounter
   * @return Encounter
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Encounter result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Encounter with limit of returned records
   * @param max - number of records
   * @return a list Encounter
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Encounter> result = service.select(input);
  ...
  /**
   * Query Encounter based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.ENCOUNTER_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Encounter by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("episodeofcare")
  public Response episodeofcare(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findByEpisodeOfCare(new QueryBuilder(params));
  ...
  */
  ...
  public Response incomingreferral(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findByIncomingReferral(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("reason")
  public Response reason(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findByReason(new QueryBuilder(params));
  ...
  */
  ...
  public Response serviceprovider(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findByServiceProvider(new QueryBuilder(params));
  ...
  */
  ...
  public Response partof(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Encounter> result = this.service.findByPartOf(new QueryBuilder(params));
