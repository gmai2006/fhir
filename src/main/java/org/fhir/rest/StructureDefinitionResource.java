...
public class StructureDefinitionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public StructureDefinition createOrUpdate(StructureDefinition obj) {
	...
	/**
	 * InIdempotent method
   * Update existing StructureDefinition
   * @param obj - instance of StructureDefinition
   ...
   */
	...
	/**
   * Delete existing StructureDefinition
   * @param obj - instance of StructureDefinition
   * @return StructureDefinition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get StructureDefinition by its ID
   * @param id - instance of StructureDefinition
   * @return StructureDefinition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	StructureDefinition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all StructureDefinition with limit of returned records
   * @param max - number of records
   * @return a list StructureDefinition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<StructureDefinition> result = service.select(input);
  ...
  /**
   * Query StructureDefinition based on basic field names
   * @param UriInfo - UriInfo
   * @return list of StructureDefinition
   */
  @GET
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.STRUCTUREDEFINITION_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query StructureDefinition by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<StructureDefinition> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response keyword(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<StructureDefinition> result = this.service.findByKeyword(new QueryBuilder(params));
