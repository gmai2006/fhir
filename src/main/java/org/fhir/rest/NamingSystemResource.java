...
public class NamingSystemResource {
  ...
  @Path("")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<NamingSystem> findByField(@QueryParam("parameter")String parameter) {
  ...
  */
  ...
  @Path("contact/name")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<NamingSystem> contact(@QueryParam("parameter")String parameter) {
  	java.util.Map<String, String> params = QueryParser.parse(parameter, VALID_FIELDS);
  	return this.service.findByContact(new QueryBuilder(params));
  }
