...
public class NamingSystemResource {
  ...
  public Response find(@PathParam("id") String id) {
  	NamingSystem result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<NamingSystem> result = service.select(input);
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<NamingSystem> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<NamingSystem> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("replacedby")
  public Response replacedby(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<NamingSystem> result = this.service.findByReplacedBy(new QueryBuilder(params));
