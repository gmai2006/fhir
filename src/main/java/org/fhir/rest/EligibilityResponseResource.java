...
public class EligibilityResponseResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public EligibilityResponse createOrUpdate(EligibilityResponse obj) {
	...
	/**
	 * InIdempotent method
   * Update existing EligibilityResponse
   * @param obj - instance of EligibilityResponse
   ...
   */
	...
	/**
   * Delete existing EligibilityResponse
   * @param obj - instance of EligibilityResponse
   * @return EligibilityResponse
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get EligibilityResponse by its ID
   * @param id - instance of EligibilityResponse
   * @return EligibilityResponse
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	EligibilityResponse result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all EligibilityResponse with limit of returned records
   * @param max - number of records
   * @return a list EligibilityResponse
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<EligibilityResponse> result = service.select(input);
  ...
  /**
   * Query EligibilityResponse based on basic field names
   * @param UriInfo - UriInfo
   * @return list of EligibilityResponse
   */
  @GET
  ...
  /**
   * Query EligibilityResponse by composite fields
  ...
  */
  ...
  public Response requestprovider(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EligibilityResponse> result = this.service.findByRequestProvider(new QueryBuilder(params));
  ...
  */
  ...
  public Response requestorganization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EligibilityResponse> result = this.service.findByRequestOrganization(new QueryBuilder(params));
  ...
  */
  ...
  public Response request(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EligibilityResponse> result = this.service.findByRequest(new QueryBuilder(params));
  ...
  */
  ...
  public Response outcome(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EligibilityResponse> result = this.service.findByOutcome(new QueryBuilder(params));
  ...
  */
  ...
  public Response insurer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EligibilityResponse> result = this.service.findByInsurer(new QueryBuilder(params));
