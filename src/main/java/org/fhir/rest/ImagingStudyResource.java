...
public class ImagingStudyResource {
  ...
  @GET
  public ImagingStudy findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<ImagingStudy> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<ImagingStudy> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingStudy> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingStudy> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ImagingStudy> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("context")
  public List<ImagingStudy> context(@QueryParam("context")String context) {
  ...
  */
  @GET
  @Path("basedon")
  public List<ImagingStudy> basedon(@QueryParam("basedon")String basedon) {
  ...
  */
  @GET
  public List<ImagingStudy> study(@QueryParam("study")String study) {
  ...
  */
  @GET
  public List<ImagingStudy> started(@QueryParam("started")String started) {
  	java.util.Map<String, String> params = QueryParser.parse(started, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<ImagingStudy> reason(@QueryParam("reason")String reason) {
