...
public class OperationDefinitionResource {
  ...
  @Path("")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<OperationDefinition> findByField(@QueryParam("parameter")String parameter) {
  ...
  */
  ...
  @Path("base")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<OperationDefinition> base(@QueryParam("parameter")String parameter) {
  	java.util.Map<String, String> params = QueryParser.parse(parameter, VALID_FIELDS);
  	return this.service.findByBase(new QueryBuilder(params));
  }
