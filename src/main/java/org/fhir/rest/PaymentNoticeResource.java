...
public class PaymentNoticeResource {
  ...
  public Response find(@PathParam("id") String id) {
  	PaymentNotice result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<PaymentNotice> result = service.select(input);
  ...
  */
  ...
  public Response request(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PaymentNotice> result = this.service.findByRequest(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("response")
  public Response response(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PaymentNotice> result = this.service.findByResponse(new QueryBuilder(params));
  ...
  */
  ...
  public Response provider(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PaymentNotice> result = this.service.findByProvider(new QueryBuilder(params));
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PaymentNotice> result = this.service.findByOrganization(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("paymentstatus")
  public Response paymentstatus(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<PaymentNotice> result = this.service.findByPaymentStatus(new QueryBuilder(params));
