...
public class PersonResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Person createOrUpdate(Person obj) {
   ...
   * @param id - instance of Person
   * @return Person
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Person result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Person with limit of returned records
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Person> result = service.select(input);
  ...
  /**
   * Query Person based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.PERSON_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Person by composite fields
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Person> result = this.service.findByManagingOrganization(new QueryBuilder(params));
