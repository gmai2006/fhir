...
public class ProcessResponseResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ProcessResponse createOrUpdate(ProcessResponse obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ProcessResponse
   * @param obj - instance of ProcessResponse
   ...
   */
	...
	/**
   * Delete existing ProcessResponse
   * @param obj - instance of ProcessResponse
   * @return ProcessResponse
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ProcessResponse by its ID
   * @param id - instance of ProcessResponse
   * @return ProcessResponse
   */
  @GET
  @Path("{id}")
  ...
  /**
   * Select all ProcessResponse with limit of returned records
   * @param max - number of records
   * @return a list ProcessResponse
   */
  @GET
  @Path("select/{max}")
  ...
  /**
   * Query ProcessResponse based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ProcessResponse
   */
  @GET
  ...
  /**
   * Query ProcessResponse by composite fields
