...
public class FamilyMemberHistoryResource {
  ...
  public Response find(@PathParam("id") String id) {
  	FamilyMemberHistory result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<FamilyMemberHistory> result = service.select(input);
  ...
  */
  ...
  public Response definition(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<FamilyMemberHistory> result = this.service.findByDefinition(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("relationship")
  public Response relationship(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<FamilyMemberHistory> result = this.service.findByRelationship(new QueryBuilder(params));
