...
import org.fhir.service.PractitionerService;
...
public class PractitionerResource {
  ...
  @Inject
  public PractitionerResource(final PractitionerService service) {
  ...
  @GET
  @Path("{id}")
  public Practitioner find(@PathParam("id") String id) {
  	return this.service.find(id);
  }

  @GET
  public Practitioner findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Practitioner> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Practitioner> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Practitioner> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Practitioner> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Practitioner> findByText(@QueryParam("_text") String _text) {
  ...
  @GET
  @Path("select/{max}")
  public List<Practitioner> findWithLimit(@PathParam("max") String max) {
  	Integer input = null;
  	try {
  ...
  */
  @GET
  public List<Practitioner> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Practitioner> name(@QueryParam("name")String name) {
  	java.util.Map<String, String> params = QueryParser.parse(name, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }
  /**
  * Descr: One of the languages that the practitioner can communicate with
  * Type: token
  */
  @GET
  public List<Practitioner> communication(@QueryParam("communication")String communication) {
  	java.util.Map<String, String> params = QueryParser.parse(communication, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "family|given|active|communication|identifier|name";
}