...
public class SubstanceResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Substance createOrUpdate(Substance obj) {
   ...
   * @param obj - instance of Substance
   * @return Substance
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get Substance by its ID
   * @param id - instance of Substance
   * @return Substance
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Substance result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Substance with limit of returned records
   * @param max - number of records
   * @return a list Substance
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Substance> result = service.select(input);
  ...
  /**
   * Query Substance based on basic field names
