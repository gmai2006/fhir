...
public class MedicationDispenseResource {
  ...
  public Response find(@PathParam("id") String id) {
  	MedicationDispense result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<MedicationDispense> result = service.select(input);
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationDispense> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationDispense> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("destination")
  public Response destination(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationDispense> result = this.service.findByDestination(new QueryBuilder(params));
  ...
  */
  ...
  public Response receiver(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationDispense> result = this.service.findByReceiver(new QueryBuilder(params));
