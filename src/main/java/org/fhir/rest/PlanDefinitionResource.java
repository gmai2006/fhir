...
public class PlanDefinitionResource {
  ...
  @GET
  public PlanDefinition findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<PlanDefinition> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<PlanDefinition> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<PlanDefinition> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<PlanDefinition> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<PlanDefinition> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<PlanDefinition> url(@QueryParam("url")String url) {
  ...
  */
  @GET
  public List<PlanDefinition> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<PlanDefinition> version(@QueryParam("version")String version) {
  ...
  */
  @GET
  public List<PlanDefinition> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<PlanDefinition> title(@QueryParam("title")String title) {
  ...
  */
  @GET
  public List<PlanDefinition> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<PlanDefinition> publisher(@QueryParam("publisher")String publisher) {
  ...
  */
  @GET
  public List<PlanDefinition> description(@QueryParam("description")String description) {
  ...
  */
  @GET
  public List<PlanDefinition> effective(@QueryParam("effective")String effective) {
  ...
  */
  @GET
  public List<PlanDefinition> jurisdiction(@QueryParam("jurisdiction")String jurisdiction) {
  ...
  */
  @GET
  public List<PlanDefinition> topic(@QueryParam("topic")String topic) {
