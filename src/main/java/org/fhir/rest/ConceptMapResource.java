...
public class ConceptMapResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ConceptMap createOrUpdate(ConceptMap obj) {
   ...
   * @param obj - instance of ConceptMap
   * @return ConceptMap
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get ConceptMap by its ID
   * @param id - instance of ConceptMap
   * @return ConceptMap
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ConceptMap result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ConceptMap with limit of returned records
   * @param max - number of records
   * @return a list ConceptMap
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ConceptMap> result = service.select(input);
  ...
  /**
   * Query ConceptMap based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ConceptMap
   */
  @GET
  ...
  /**
   * Query ConceptMap by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ConceptMap> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response source(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ConceptMap> result = this.service.findBySourceReference(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("target")
  public Response target(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ConceptMap> result = this.service.findByTargetReference(new QueryBuilder(params));
