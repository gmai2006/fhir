...
public class DeviceMetricResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public DeviceMetric createOrUpdate(DeviceMetric obj) {
	...
	/**
	 * InIdempotent method
   * Update existing DeviceMetric
   * @param obj - instance of DeviceMetric
   * @return DeviceMetric
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get DeviceMetric by its ID
   * @param id - instance of DeviceMetric
   * @return DeviceMetric
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	DeviceMetric result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all DeviceMetric with limit of returned records
   * @param max - number of records
   * @return a list DeviceMetric
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DeviceMetric> result = service.select(input);
  ...
  /**
   * Query DeviceMetric based on basic field names
   * @param UriInfo - UriInfo
   * @return list of DeviceMetric
   */
  @GET
  ...
  /**
   * Query DeviceMetric by composite fields
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceMetric> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response source(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceMetric> result = this.service.findBySource(new QueryBuilder(params));
  ...
  */
  ...
  public Response parent(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DeviceMetric> result = this.service.findByParent(new QueryBuilder(params));
