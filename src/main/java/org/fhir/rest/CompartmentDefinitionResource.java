...
public class CompartmentDefinitionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public CompartmentDefinition createOrUpdate(CompartmentDefinition obj) {
	...
	/**
	 * InIdempotent method
   * Update existing CompartmentDefinition
   * @param obj - instance of CompartmentDefinition
   ...
   */
	...
	/**
   * Delete existing CompartmentDefinition
   * @param obj - instance of CompartmentDefinition
   * @return CompartmentDefinition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get CompartmentDefinition by its ID
   * @param id - instance of CompartmentDefinition
   * @return CompartmentDefinition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	CompartmentDefinition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all CompartmentDefinition with limit of returned records
   * @param max - number of records
   * @return a list CompartmentDefinition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<CompartmentDefinition> result = service.select(input);
  ...
  /**
   * Query CompartmentDefinition based on basic field names
   * @param UriInfo - UriInfo
   * @return list of CompartmentDefinition
   */
  @GET
  ...
  /**
   * Query CompartmentDefinition by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CompartmentDefinition> result = this.service.findByJurisdiction(new QueryBuilder(params));
