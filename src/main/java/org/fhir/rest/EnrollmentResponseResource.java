...
public class EnrollmentResponseResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public EnrollmentResponse createOrUpdate(EnrollmentResponse obj) {
	...
	/**
	 * InIdempotent method
   * Update existing EnrollmentResponse
   * @param obj - instance of EnrollmentResponse
   ...
   */
	...
	/**
   * Delete existing EnrollmentResponse
   * @param obj - instance of EnrollmentResponse
   * @return EnrollmentResponse
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get EnrollmentResponse by its ID
   * @param id - instance of EnrollmentResponse
   * @return EnrollmentResponse
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	EnrollmentResponse result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all EnrollmentResponse with limit of returned records
   * @param max - number of records
   * @return a list EnrollmentResponse
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<EnrollmentResponse> result = service.select(input);
  ...
  /**
   * Query EnrollmentResponse based on basic field names
  ...
  /**
   * Query EnrollmentResponse by composite fields
  ...
  */
  ...
  public Response request(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EnrollmentResponse> result = this.service.findByRequest(new QueryBuilder(params));
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EnrollmentResponse> result = this.service.findByOrganization(new QueryBuilder(params));
