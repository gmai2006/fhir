...
public class ActivityDefinitionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ActivityDefinition createOrUpdate(ActivityDefinition obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ActivityDefinition
   * @param obj - instance of ActivityDefinition
   ...
   */
	...
	/**
   * Delete existing ActivityDefinition
   * @param obj - instance of ActivityDefinition
   * @return ActivityDefinition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ActivityDefinition by its ID
   * @param id - instance of ActivityDefinition
   * @return ActivityDefinition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ActivityDefinition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ActivityDefinition with limit of returned records
   * @param max - number of records
   * @return a list ActivityDefinition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ActivityDefinition> result = service.select(input);
  ...
  /**
   * Query ActivityDefinition based on basic field names
  ...
  /**
   * Query ActivityDefinition by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ActivityDefinition> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response topic(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ActivityDefinition> result = this.service.findByTopic(new QueryBuilder(params));
