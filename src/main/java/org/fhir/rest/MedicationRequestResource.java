...
public class MedicationRequestResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public MedicationRequest createOrUpdate(MedicationRequest obj) {
	...
	/**
	 * InIdempotent method
   * Update existing MedicationRequest
   * @param obj - instance of MedicationRequest
   ...
   */
	...
	/**
   * Delete existing MedicationRequest
   * @param obj - instance of MedicationRequest
   * @return MedicationRequest
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get MedicationRequest by its ID
   * @param id - instance of MedicationRequest
   * @return MedicationRequest
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	MedicationRequest result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all MedicationRequest with limit of returned records
   * @param max - number of records
   * @return a list MedicationRequest
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<MedicationRequest> result = service.select(input);
  ...
  /**
   * Query MedicationRequest based on basic field names
  ...
  /**
   * Query MedicationRequest by composite fields
  ...
  */
  ...
  public Response category(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationRequest> result = this.service.findByCategory(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationRequest> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<MedicationRequest> result = this.service.findByContext(new QueryBuilder(params));
