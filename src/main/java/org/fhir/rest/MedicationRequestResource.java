...
public class MedicationRequestResource {
  ...
  @GET
  public MedicationRequest findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<MedicationRequest> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<MedicationRequest> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationRequest> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationRequest> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<MedicationRequest> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<MedicationRequest> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("context")
  public List<MedicationRequest> context(@QueryParam("context")String context) {
  ...
  */
  @GET
  public List<MedicationRequest> intent(@QueryParam("intent")String intent) {
  ...
  */
  @GET
  public List<MedicationRequest> category(@QueryParam("category")String category) {
  ...
  */
  @GET
  public List<MedicationRequest> priority(@QueryParam("priority")String priority) {
  	java.util.Map<String, String> params = QueryParser.parse(priority, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "identifier|medication|patient|status|authoredon|category|context|date|intendeddispenser|intent|priority|requester|subject";
}