...
public class GroupResource {
  ...
  @GET
  public Group findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Group> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Group> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Group> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Group> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Group> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<Group> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Group> type(@QueryParam("type")String type) {
  ...
  */
  @GET
  public List<Group> code(@QueryParam("code")String code) {
  	java.util.Map<String, String> params = QueryParser.parse(code, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "actual|characteristic|characteristicvalue|code|exclude|identifier|member|type|value";
}