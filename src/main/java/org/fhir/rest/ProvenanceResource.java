...
public class ProvenanceResource {
  ...
  public Response find(@PathParam("id") String id) {
  	Provenance result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Provenance> result = service.select(input);
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Provenance> result = this.service.findByTarget(new QueryBuilder(params));
  ...
  */
  ...
  public Response location(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Provenance> result = this.service.findByLocation(new QueryBuilder(params));
