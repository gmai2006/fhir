...
public class ProvenanceResource {
  ...
  @GET
  public Provenance findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Provenance> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Provenance> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Provenance> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Provenance> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Provenance> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<Provenance> patient(@QueryParam("patient")String patient) {
  	java.util.Map<String, String> params = QueryParser.parse(patient, VALID_FIELDS);
  	return this.service.findByTarget(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  @Path("location")
  public List<Provenance> location(@QueryParam("location")String location) {
  ...
  */
  @GET
  public List<Provenance> recorded(@QueryParam("recorded")String recorded) {
  	java.util.Map<String, String> params = QueryParser.parse(recorded, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "agent|agentrole|end|entityid|entityref|location|patient|recorded|signaturetype|start|target";
}