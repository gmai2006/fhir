...
public class CareTeamResource {
  ...
  @GET
  public CareTeam findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<CareTeam> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<CareTeam> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<CareTeam> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<CareTeam> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<CareTeam> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<CareTeam> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("encounter")
  public List<CareTeam> encounter(@QueryParam("encounter")String encounter) {
  ...
  */
  @GET
  public List<CareTeam> status(@QueryParam("status")String status) {
  	java.util.Map<String, String> params = QueryParser.parse(status, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "category|context|encounter|participant|status|subject";
}