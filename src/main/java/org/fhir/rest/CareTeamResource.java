...
public class CareTeamResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public CareTeam createOrUpdate(CareTeam obj) {
   ...
   * @param obj - instance of CareTeam
   * @return CareTeam
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get CareTeam by its ID
   * @param id - instance of CareTeam
   * @return CareTeam
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	CareTeam result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all CareTeam with limit of returned records
   * @param max - number of records
   * @return a list CareTeam
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<CareTeam> result = service.select(input);
  ...
  /**
   * Query CareTeam based on basic field names
   * @param UriInfo - UriInfo
   * @return list of CareTeam
   */
  @GET
  ...
  /**
   * Query CareTeam by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CareTeam> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response encounter(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CareTeam> result = this.service.findByContext(new QueryBuilder(params));
