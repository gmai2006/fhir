...
public class ImplementationGuideResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ImplementationGuide createOrUpdate(ImplementationGuide obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ImplementationGuide
   * @param obj - instance of ImplementationGuide
   ...
   */
	...
	/**
   * Delete existing ImplementationGuide
   * @param obj - instance of ImplementationGuide
   * @return ImplementationGuide
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ImplementationGuide by its ID
   * @param id - instance of ImplementationGuide
   * @return ImplementationGuide
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ImplementationGuide result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ImplementationGuide with limit of returned records
   * @param max - number of records
   * @return a list ImplementationGuide
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ImplementationGuide> result = service.select(input);
  ...
  /**
   * Query ImplementationGuide based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ImplementationGuide
   */
  @GET
  ...
  /**
   * Query ImplementationGuide by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ImplementationGuide> result = this.service.findByJurisdiction(new QueryBuilder(params));
