...
public class ImplementationGuideResource {
  ...
  @Path("")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<ImplementationGuide> findByField(@QueryParam("parameter")String parameter) {
  ...
  */
  ...
  @Path("dependency/uri")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public List<ImplementationGuide> dependency(@QueryParam("parameter")String parameter) {
  	java.util.Map<String, String> params = QueryParser.parse(parameter, VALID_FIELDS);
  	return this.service.findByDependency(new QueryBuilder(params));
  }
