...
public class SlotResource {
  ...
  @GET
  public Slot findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Slot> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Slot> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Slot> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Slot> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Slot> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("schedule")
  public List<Slot> schedule(@QueryParam("schedule")String schedule) {
  	java.util.Map<String, String> params = QueryParser.parse(schedule, VALID_FIELDS);
  	return this.service.findBySchedule(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<Slot> slottype(@QueryParam("slottype")String slottype) {
  	java.util.Map<String, String> params = QueryParser.parse(slottype, VALID_FIELDS);
  ...
  */
  @GET
  public List<Slot> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Slot> start(@QueryParam("start")String start) {
  	java.util.Map<String, String> params = QueryParser.parse(start, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "identifier|schedule|slottype|start|status";
}