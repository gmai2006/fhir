...
public class DataElementResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public DataElement createOrUpdate(DataElement obj) {
	...
	/**
	 * InIdempotent method
   * Update existing DataElement
   * @param obj - instance of DataElement
   * @return DataElement
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get DataElement by its ID
   * @param id - instance of DataElement
   * @return DataElement
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	DataElement result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all DataElement with limit of returned records
   * @param max - number of records
   * @return a list DataElement
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<DataElement> result = service.select(input);
  ...
  /**
   * Query DataElement based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.DATAELEMENT_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query DataElement by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<DataElement> result = this.service.findByJurisdiction(new QueryBuilder(params));
