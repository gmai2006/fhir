...
public class DataElementResource {
  ...
  @GET
  public DataElement findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<DataElement> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<DataElement> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DataElement> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DataElement> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<DataElement> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<DataElement> url(@QueryParam("url")String url) {
  ...
  */
  @GET
  public List<DataElement> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<DataElement> version(@QueryParam("version")String version) {
  ...
  */
  @GET
  public List<DataElement> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<DataElement> publisher(@QueryParam("publisher")String publisher) {
  ...
  */
  @GET
  public List<DataElement> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<DataElement> title(@QueryParam("title")String title) {
  ...
  */
  @GET
  public List<DataElement> jurisdiction(@QueryParam("jurisdiction")String jurisdiction) {
  ...
  */
  @GET
  public List<DataElement> stringency(@QueryParam("stringency")String stringency) {
  	java.util.Map<String, String> params = QueryParser.parse(stringency, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "code|date|description|identifier|jurisdiction|name|publisher|status|stringency|title|url|version|objectClass|objectClassProperty";
}