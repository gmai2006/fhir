...
public class SupplyRequestResource {
  ...
  public Response find(@PathParam("id") String id) {
  	SupplyRequest result = this.service.find(id);
  	if (null == result) {
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<SupplyRequest> result = service.select(input);
  ...
  */
  ...
  public Response supplier(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<SupplyRequest> result = this.service.findBySupplier(new QueryBuilder(params));
