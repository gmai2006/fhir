...
public class SearchParameterResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public SearchParameter createOrUpdate(SearchParameter obj) {
   ...
   * @param obj - instance of SearchParameter
   ...
   */
	...
	/**
   * Delete existing SearchParameter
   * @param obj - instance of SearchParameter
   * @return SearchParameter
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get SearchParameter by its ID
   * @param id - instance of SearchParameter
   * @return SearchParameter
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	SearchParameter result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all SearchParameter with limit of returned records
   * @param max - number of records
   * @return a list SearchParameter
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<SearchParameter> result = service.select(input);
  ...
  /**
   * Query SearchParameter based on basic field names
   * @param UriInfo - UriInfo
   * @return list of SearchParameter
   */
  @GET
  ...
  /**
   * Query SearchParameter by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<SearchParameter> result = this.service.findByJurisdiction(new QueryBuilder(params));
