...
public class CompositionResource {
  ...
  @GET
  public Composition findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Composition> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Composition> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Composition> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Composition> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Composition> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("subject")
  public List<Composition> subject(@QueryParam("subject")String subject) {
  ...
  */
  @GET
  @Path("author")
  public List<Composition> author(@QueryParam("author")String author) {
  ...
  */
  @GET
  public List<Composition> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Composition> title(@QueryParam("title")String title) {
  ...
  */
  @GET
  public List<Composition> confidentiality(@QueryParam("confidentiality")String confidentiality) {
  	java.util.Map<String, String> params = QueryParser.parse(confidentiality, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "attester|author|FHIRclass|confidentiality|context|entry|period|relatedid|relatedref|section|status|subject|title";
}