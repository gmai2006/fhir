...
public class CompositionResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Composition createOrUpdate(Composition obj) {
   ...
   * @param obj - instance of Composition
   * @return Composition
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get Composition by its ID
   * @param id - instance of Composition
   * @return Composition
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Composition result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Composition with limit of returned records
   * @param max - number of records
   * @return a list Composition
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Composition> result = service.select(input);
  ...
  /**
   * Query Composition based on basic field names
  ...
  /**
   * Query Composition by composite fields
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Composition> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response author(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Composition> result = this.service.findByAuthor(new QueryBuilder(params));
