...
public class ExplanationOfBenefitResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ExplanationOfBenefit createOrUpdate(ExplanationOfBenefit obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ExplanationOfBenefit
   * @param obj - instance of ExplanationOfBenefit
   ...
   */
	...
	/**
   * Delete existing ExplanationOfBenefit
   * @param obj - instance of ExplanationOfBenefit
   * @return ExplanationOfBenefit
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ExplanationOfBenefit by its ID
   * @param id - instance of ExplanationOfBenefit
   * @return ExplanationOfBenefit
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ExplanationOfBenefit result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ExplanationOfBenefit with limit of returned records
   * @param max - number of records
   * @return a list ExplanationOfBenefit
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ExplanationOfBenefit> result = service.select(input);
  ...
  /**
   * Query ExplanationOfBenefit based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ExplanationOfBenefit
   */
  @GET
  ...
  /**
   * Query ExplanationOfBenefit by composite fields
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByPatient(new QueryBuilder(params));
  ...
  */
  ...
  public Response enterer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByEnterer(new QueryBuilder(params));
  ...
  */
  ...
  public Response provider(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByProvider(new QueryBuilder(params));
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByOrganization(new QueryBuilder(params));
  ...
  */
  ...
  public Response facility(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByFacility(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("claim")
  public Response claim(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExplanationOfBenefit> result = this.service.findByClaim(new QueryBuilder(params));
