...
public class DeviceUseStatementResource {
  ...
  * expr: device
  * Xpath: f:DeviceUseStatement/f:device
  * Type: reference
  * Code: device
  */
  @GET
  @Path("device")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public DeviceUseStatement device() {
  	return new DeviceUseStatement();
  }
  /**
  * Descr: Search by identifier
  * expr: identifier
  * Xpath: f:DeviceUseStatement/f:identifier
  * Type: token
  * Code: identifier
  */
  @GET
  @Path("identifier")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public DeviceUseStatement identifier(@QueryParam("identifier")String identifier) {
  	return new DeviceUseStatement();
  }
  /**
  ...
  */
  ...
  @Path("subject")
  @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON}) 
  public DeviceUseStatement subject() {
  	return new DeviceUseStatement();
  }
}