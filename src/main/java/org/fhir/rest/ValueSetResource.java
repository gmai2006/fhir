...
public class ValueSetResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ValueSet createOrUpdate(ValueSet obj) {
   ...
   * @param obj - instance of ValueSet
   * @return ValueSet
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   */
	...
	/**
   * Get ValueSet by its ID
   * @param id - instance of ValueSet
   * @return ValueSet
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ValueSet result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ValueSet with limit of returned records
   * @param max - number of records
   * @return a list ValueSet
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ValueSet> result = service.select(input);
  ...
  /**
   * Query ValueSet based on basic field names
  ...
  /**
   * Query ValueSet by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ValueSet> result = this.service.findByJurisdiction(new QueryBuilder(params));
