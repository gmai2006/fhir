...
public class CapabilityStatementResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public CapabilityStatement createOrUpdate(CapabilityStatement obj) {
	...
	/**
	 * InIdempotent method
   * Update existing CapabilityStatement
   * @param obj - instance of CapabilityStatement
   ...
   */
	...
	/**
   * Delete existing CapabilityStatement
   * @param obj - instance of CapabilityStatement
   * @return CapabilityStatement
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get CapabilityStatement by its ID
   * @param id - instance of CapabilityStatement
   * @return CapabilityStatement
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	CapabilityStatement result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all CapabilityStatement with limit of returned records
   * @param max - number of records
   * @return a list CapabilityStatement
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<CapabilityStatement> result = service.select(input);
  ...
  /**
   * Query CapabilityStatement based on basic field names
   * @param UriInfo - UriInfo
   * @return list of CapabilityStatement
   */
  @GET
  ...
  /**
   * Query CapabilityStatement by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CapabilityStatement> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response supportedprofile(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<CapabilityStatement> result = this.service.findByProfile(new QueryBuilder(params));
