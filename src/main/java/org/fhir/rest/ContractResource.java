...
public class ContractResource {
  ...
  @GET
  public Contract findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Contract> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Contract> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Contract> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Contract> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Contract> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<Contract> patient(@QueryParam("patient")String patient) {
  ...
  */
  @GET
  @Path("authority")
  public List<Contract> authority(@QueryParam("authority")String authority) {
  	java.util.Map<String, String> params = QueryParser.parse(authority, VALID_FIELDS);
  	return this.service.findByAuthority(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  @Path("domain")
  public List<Contract> domain(@QueryParam("domain")String domain) {
  	java.util.Map<String, String> params = QueryParser.parse(domain, VALID_FIELDS);
  	return this.service.findByDomain(new QueryBuilder(params));
  }
  /**
  ...
  */
  @GET
  public List<Contract> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Contract> issued(@QueryParam("issued")String issued) {
  	java.util.Map<String, String> params = QueryParser.parse(issued, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "agent|authority|domain|identifier|issued|patient|signer|subject|termtopic";
}