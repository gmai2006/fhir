...
import org.fhir.service.EnrollmentRequestService;
...
public class EnrollmentRequestResource {
  ...
  @Inject
  public EnrollmentRequestResource(final EnrollmentRequestService service) {
	...
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public EnrollmentRequest create(EnrollmentRequest obj) {
		return this.service.create(obj);
	}

	@Consumes(MediaType.APPLICATION_JSON)
	@POST
	public EnrollmentRequest update( EnrollmentRequest obj) {
  ...
  @GET
  @Path("{id}")
  public EnrollmentRequest find(@PathParam("id") String id) {
  	return this.service.find(id);
  }

  @GET
  public EnrollmentRequest findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<EnrollmentRequest> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<EnrollmentRequest> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<EnrollmentRequest> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<EnrollmentRequest> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<EnrollmentRequest> findByText(@QueryParam("_text") String _text) {
  ...
  @GET
  @Path("select/{max}")
  public List<EnrollmentRequest> findWithLimit(@PathParam("max") String max) {
  	Integer input = null;
  	try {
  ...
  */
  @GET
  @Path("organization")
  public List<EnrollmentRequest> organization(@QueryParam("organization")String organization) {
  ...
  /**
  * Descr: The party to be enrolled
  * Type: reference
  */
  @GET
  @Path("patient")
  public List<EnrollmentRequest> patient(@QueryParam("patient")String patient) {
  ...
  private static final String VALID_FIELDS = "identifier|organization|patient|subject";
}