...
public class EnrollmentRequestResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public EnrollmentRequest createOrUpdate(EnrollmentRequest obj) {
	...
	/**
	 * InIdempotent method
   * Update existing EnrollmentRequest
   * @param obj - instance of EnrollmentRequest
   ...
   */
	...
	/**
   * Delete existing EnrollmentRequest
   * @param obj - instance of EnrollmentRequest
   * @return EnrollmentRequest
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get EnrollmentRequest by its ID
   * @param id - instance of EnrollmentRequest
   * @return EnrollmentRequest
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	EnrollmentRequest result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all EnrollmentRequest with limit of returned records
   * @param max - number of records
   * @return a list EnrollmentRequest
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<EnrollmentRequest> result = service.select(input);
  ...
  /**
   * Query EnrollmentRequest based on basic field names
   * @param UriInfo - UriInfo
   * @return list of EnrollmentRequest
   */
  @GET
  ...
  /**
   * Query EnrollmentRequest by composite fields
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EnrollmentRequest> result = this.service.findByOrganization(new QueryBuilder(params));
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<EnrollmentRequest> result = this.service.findBySubject(new QueryBuilder(params));
