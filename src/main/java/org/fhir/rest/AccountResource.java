...
public class AccountResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Account createOrUpdate(Account obj) {
   ...
   * @param id - instance of Account
   * @return Account
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Account result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Account with limit of returned records
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Account> result = service.select(input);
  ...
  /**
   * Query Account based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.ACCOUNT_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Account by composite fields
  ...
  */
  ...
  public Response type(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Account> result = this.service.findByType(new QueryBuilder(params));
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Account> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response owner(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Account> result = this.service.findByOwner(new QueryBuilder(params));
