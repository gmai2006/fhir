...
public class AccountResource {
  ...
  @GET
  public Account findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Account> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Account> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Account> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Account> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Account> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<Account> patient(@QueryParam("patient")String patient) {
  ...
  */
  @GET
  @Path("owner")
  public List<Account> owner(@QueryParam("owner")String owner) {
  ...
  */
  @GET
  public List<Account> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Account> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Account> type(@QueryParam("type")String type) {
  ...
  */
  @GET
  public List<Account> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<Account> period(@QueryParam("period")String period) {
  	java.util.Map<String, String> params = QueryParser.parse(period, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "balance|identifier|name|owner|patient|period|status|subject|type";
}