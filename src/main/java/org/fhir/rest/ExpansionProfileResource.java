...
public class ExpansionProfileResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ExpansionProfile createOrUpdate(ExpansionProfile obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ExpansionProfile
   * @param obj - instance of ExpansionProfile
   ...
   */
	...
	/**
   * Delete existing ExpansionProfile
   * @param obj - instance of ExpansionProfile
   * @return ExpansionProfile
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ExpansionProfile by its ID
   * @param id - instance of ExpansionProfile
   * @return ExpansionProfile
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ExpansionProfile result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ExpansionProfile with limit of returned records
   * @param max - number of records
   * @return a list ExpansionProfile
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ExpansionProfile> result = service.select(input);
  ...
  /**
   * Query ExpansionProfile based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ExpansionProfile
   */
  @GET
  ...
  /**
   * Query ExpansionProfile by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ExpansionProfile> result = this.service.findByJurisdiction(new QueryBuilder(params));
