...
public class ExpansionProfileResource {
  ...
  @GET
  public ExpansionProfile findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<ExpansionProfile> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<ExpansionProfile> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ExpansionProfile> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ExpansionProfile> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<ExpansionProfile> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<ExpansionProfile> url(@QueryParam("url")String url) {
  ...
  */
  @GET
  public List<ExpansionProfile> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<ExpansionProfile> version(@QueryParam("version")String version) {
  ...
  */
  @GET
  public List<ExpansionProfile> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<ExpansionProfile> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<ExpansionProfile> publisher(@QueryParam("publisher")String publisher) {
  ...
  */
  @GET
  public List<ExpansionProfile> description(@QueryParam("description")String description) {
  ...
  */
  @GET
  public List<ExpansionProfile> jurisdiction(@QueryParam("jurisdiction")String jurisdiction) {
