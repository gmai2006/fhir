...
public class ProcedureRequestResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public ProcedureRequest createOrUpdate(ProcedureRequest obj) {
	...
	/**
	 * InIdempotent method
   * Update existing ProcedureRequest
   * @param obj - instance of ProcedureRequest
   ...
   */
	...
	/**
   * Delete existing ProcedureRequest
   * @param obj - instance of ProcedureRequest
   * @return ProcedureRequest
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get ProcedureRequest by its ID
   * @param id - instance of ProcedureRequest
   * @return ProcedureRequest
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	ProcedureRequest result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all ProcedureRequest with limit of returned records
   * @param max - number of records
   * @return a list ProcedureRequest
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<ProcedureRequest> result = service.select(input);
  ...
  /**
   * Query ProcedureRequest based on basic field names
   * @param UriInfo - UriInfo
   * @return list of ProcedureRequest
   */
  @GET
  ...
  /**
   * Query ProcedureRequest by composite fields
  ...
  */
  ...
  public Response definition(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByDefinition(new QueryBuilder(params));
  ...
  */
  ...
  public Response basedon(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByBasedOn(new QueryBuilder(params));
  ...
  */
  ...
  public Response replaces(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByReplaces(new QueryBuilder(params));
  ...
  */
  ...
  public Response subject(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findBySubject(new QueryBuilder(params));
  ...
  */
  ...
  public Response context(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByContext(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("performertype")
  public Response performertype(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByPerformerType(new QueryBuilder(params));
  ...
  */
  ...
  public Response performer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByPerformer(new QueryBuilder(params));
  ...
  */
  ...
  public Response specimen(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findBySpecimen(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("bodysite")
  public Response bodysite(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<ProcedureRequest> result = this.service.findByBodySite(new QueryBuilder(params));
