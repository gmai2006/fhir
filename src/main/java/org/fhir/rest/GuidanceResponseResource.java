...
public class GuidanceResponseResource {
  ...
  @GET
  public GuidanceResponse findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<GuidanceResponse> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<GuidanceResponse> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<GuidanceResponse> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<GuidanceResponse> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<GuidanceResponse> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<GuidanceResponse> patient(@QueryParam("patient")String patient) {
  ...
  */
  @GET
  public List<GuidanceResponse> request(@QueryParam("request")String request) {
  	java.util.Map<String, String> params = QueryParser.parse(request, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "identifier|patient|request|subject";
}