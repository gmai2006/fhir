...
public class GuidanceResponseResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public GuidanceResponse createOrUpdate(GuidanceResponse obj) {
	...
	/**
	 * InIdempotent method
   * Update existing GuidanceResponse
   * @param obj - instance of GuidanceResponse
   ...
   */
	...
	/**
   * Delete existing GuidanceResponse
   * @param obj - instance of GuidanceResponse
   * @return GuidanceResponse
   */
	@Consumes(MediaType.APPLICATION_JSON)
	...
	/**
   * Get GuidanceResponse by its ID
   * @param id - instance of GuidanceResponse
   * @return GuidanceResponse
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	GuidanceResponse result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all GuidanceResponse with limit of returned records
   * @param max - number of records
   * @return a list GuidanceResponse
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<GuidanceResponse> result = service.select(input);
  ...
  /**
   * Query GuidanceResponse based on basic field names
   * @param UriInfo - UriInfo
   * @return list of GuidanceResponse
   */
  @GET
  ...
  /**
   * Query GuidanceResponse by composite fields
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<GuidanceResponse> result = this.service.findBySubject(new QueryBuilder(params));
