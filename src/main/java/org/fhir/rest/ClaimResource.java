...
public class ClaimResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Claim createOrUpdate(Claim obj) {
   ...
   */
	...
	/**
   * Get Claim by its ID
   * @param id - instance of Claim
   * @return Claim
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Claim result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Claim with limit of returned records
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Claim> result = service.select(input);
  ...
  /**
   * Query Claim based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.CLAIM_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Claim by composite fields
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByPatient(new QueryBuilder(params));
  ...
  */
  ...
  public Response enterer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByEnterer(new QueryBuilder(params));
  ...
  */
  ...
  public Response insurer(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByInsurer(new QueryBuilder(params));
  ...
  */
  ...
  public Response provider(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByProvider(new QueryBuilder(params));
  ...
  */
  ...
  public Response organization(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByOrganization(new QueryBuilder(params));
  ...
  */
  @GET
  @Path("priority")
  public Response priority(@Context UriInfo info) {
  	MultivaluedMap<String, String> parameters = info.getQueryParameters();
  	if (null == parameters || parameters.isEmpty()) {
  		return Response.status(Response.Status.OK).entity(service.select(50)).build();
  	}
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByPriority(new QueryBuilder(params));
  ...
  */
  ...
  public Response facility(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Claim> result = this.service.findByFacility(new QueryBuilder(params));
