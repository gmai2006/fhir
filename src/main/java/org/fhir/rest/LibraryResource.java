...
public class LibraryResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Library createOrUpdate(Library obj) {
   ...
   * @param id - instance of Library
   * @return Library
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Library result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Library with limit of returned records
   * @param max - number of records
   * @return a list Library
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Library> result = service.select(input);
  ...
  /**
   * Query Library based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.LIBRARY_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
  ...
  /**
   * Query Library by composite fields
  ...
  */
  ...
  public Response jurisdiction(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Library> result = this.service.findByJurisdiction(new QueryBuilder(params));
  ...
  */
  ...
  public Response topic(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Library> result = this.service.findByTopic(new QueryBuilder(params));
