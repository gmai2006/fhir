...
public class LibraryResource {
  ...
  @GET
  public Library findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Library> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Library> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Library> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Library> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Library> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  public List<Library> url(@QueryParam("url")String url) {
  ...
  */
  @GET
  public List<Library> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Library> version(@QueryParam("version")String version) {
  ...
  */
  @GET
  public List<Library> name(@QueryParam("name")String name) {
  ...
  */
  @GET
  public List<Library> title(@QueryParam("title")String title) {
  ...
  */
  @GET
  public List<Library> status(@QueryParam("status")String status) {
  ...
  */
  @GET
  public List<Library> publisher(@QueryParam("publisher")String publisher) {
  ...
  */
  @GET
  public List<Library> description(@QueryParam("description")String description) {
  ...
  */
  @GET
  public List<Library> effective(@QueryParam("effective")String effective) {
  ...
  */
  @GET
  public List<Library> jurisdiction(@QueryParam("jurisdiction")String jurisdiction) {
  ...
  */
  @GET
  public List<Library> topic(@QueryParam("topic")String topic) {
