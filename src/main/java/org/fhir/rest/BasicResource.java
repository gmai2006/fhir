...
public class BasicResource {
  ...
  @GET
  public Basic findById(@QueryParam("_id") String id) {
  	return this.service.find(id);
  }

  @GET
  public List<Basic> findByLastUpdate(@QueryParam("_lastUpdated") String _lastUpdated) {
  ...
  @GET
  public List<Basic> findByTag(@QueryParam("_tag") String _tag) {
  	java.util.Map<String, String> params = QueryParser.parse(_tag, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Basic> findByProfile(@QueryParam("_profile") String _profile) {
  	java.util.Map<String, String> params = QueryParser.parse(_profile, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Basic> findBySecurity(@QueryParam("_security") String _security) {
  	java.util.Map<String, String> params = QueryParser.parse(_security, VALID_FIELDS);
  	return this.service.findByMeta(new QueryBuilder(params));
  }

  @GET
  public List<Basic> findByText(@QueryParam("_text") String _text) {
  ...
  */
  @GET
  @Path("patient")
  public List<Basic> patient(@QueryParam("patient")String patient) {
  ...
  */
  @GET
  public List<Basic> identifier(@QueryParam("identifier")String identifier) {
  ...
  */
  @GET
  public List<Basic> code(@QueryParam("code")String code) {
  ...
  */
  @GET
  public List<Basic> created(@QueryParam("created")String created) {
  	java.util.Map<String, String> params = QueryParser.parse(created, VALID_FIELDS);
  	return this.service.findByField(new QueryBuilder(params));
  }

  private static final String VALID_FIELDS = "author|code|created|identifier|patient|subject";
}