...
public class BasicResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Basic createOrUpdate(Basic obj) {
   ...
   */
	...
	/**
   * Get Basic by its ID
   * @param id - instance of Basic
   * @return Basic
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Basic result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Basic with limit of returned records
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Basic> result = service.select(input);
  ...
  /**
   * Query Basic based on basic field names
  ...
  /**
   * Query Basic by composite fields
  ...
  */
  ...
  public Response code(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Basic> result = this.service.findByCode(new QueryBuilder(params));
  ...
  */
  ...
  public Response patient(@Context UriInfo info) {
  	...
  	java.util.Map<String, String> params = QueryParser.parse(str);
  	List<Basic> result = this.service.findBySubject(new QueryBuilder(params));
