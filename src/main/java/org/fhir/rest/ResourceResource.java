...
public class ResourceResource {
   ...
   */
	@PUT
	@Consumes(MediaType.APPLICATION_JSON)
	public Resource createOrUpdate(Resource obj) {
   ...
   * @param obj - instance of Resource
   * @return Resource
   */
	@Consumes(MediaType.APPLICATION_JSON)
	@POST
   ...
   * @param id - instance of Resource
   * @return Resource
   */
  @GET
  @Path("{id}")
  public Response find(@PathParam("id") String id) {
  	Resource result = this.service.find(id);
  	if (null == result) {
  ...
  /**
   * Select all Resource with limit of returned records
  ...
  public Response findWithLimit(@PathParam("max") String max) {
  	...
  	List<Resource> result = service.select(input);
  ...
  /**
   * Query Resource based on basic field names
  ...
  public Response findByField(@Context UriInfo info) {
  	...
  	else if (FhirConstant.RESOURCE_FIELDS.contains(first)) {
  		java.util.Map<String, String> params = QueryParser.parse(str);
