...
*/
public class CapabilityStatementSupportedMessageServiceImpl implements CapabilityStatementSupportedMessageService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final CapabilityStatementSupportedMessageDao dao;

  @Inject
  public CapabilityStatementSupportedMessageServiceImpl(final CapabilityStatementSupportedMessageDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }

  public CapabilityStatementSupportedMessage find(String id) {
    final CapabilityStatementSupportedMessage result = dao.find(id);
    logger.info("find(CapabilityStatementSupportedMessage) - exited - return value={} result ");
    return result;
  }

  public List<CapabilityStatementSupportedMessage> select(int maxResult) {
      final List<CapabilityStatementSupportedMessage> result = dao.select(maxResult);
      logger.info("select(CapabilityStatementSupportedMessage) - exited - return value={} result ");

      return result;
  }

  public List<CapabilityStatementSupportedMessage> selectAll() {
      final List<CapabilityStatementSupportedMessage> results = dao.selectAll();
      logger.info("selectAll(CapabilityStatementSupportedMessage) - exited - return value={} result ");
      return results;
  }
  ...
  public void delete(CapabilityStatementSupportedMessage bean) {
  	requireNonNull(bean);
    logger.info("delete(CapabilityStatementSupportedMessage={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(CapabilityStatementSupportedMessage) - exited - return value={} result ");
  }
}