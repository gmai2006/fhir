...
*/
public class ImmunizationExplanationServiceImpl implements ImmunizationExplanationService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final ImmunizationExplanationDao dao;

  @Inject
  public ImmunizationExplanationServiceImpl(final ImmunizationExplanationDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }

  public ImmunizationExplanation find(String id) {
    final ImmunizationExplanation result = dao.find(id);
    logger.info("find(ImmunizationExplanation) - exited - return value={} result ");
    return result;
  }

  public List<ImmunizationExplanation> select(int maxResult) {
      final List<ImmunizationExplanation> result = dao.select(maxResult);
      logger.info("select(ImmunizationExplanation) - exited - return value={} result ");

      return result;
  }

  public List<ImmunizationExplanation> selectAll() {
      final List<ImmunizationExplanation> results = dao.selectAll();
      logger.info("selectAll(ImmunizationExplanation) - exited - return value={} result ");
      return results;
  }
  ...
  public void delete(ImmunizationExplanation bean) {
  	requireNonNull(bean);
    logger.info("delete(ImmunizationExplanation={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(ImmunizationExplanation) - exited - return value={} result ");
  }
}