...
public class ClaimResponseProcessNote  {
  ...
  */
  ...
  public static java.util.List<ClaimResponseProcessNote> fromArray(java.util.List<ClaimResponseProcessNoteModel> list) {
    return (java.util.List<ClaimResponseProcessNote>)list.stream()
      .map(model -> new ClaimResponseProcessNote(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ClaimResponseProcessNoteModel> toModelArray(java.util.List<ClaimResponseProcessNote> list) {
    return (java.util.List<ClaimResponseProcessNoteModel>)list.stream()
      .map(model -> new ClaimResponseProcessNoteModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
