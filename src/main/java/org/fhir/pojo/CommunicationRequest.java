  ...
  */
  ...
  public CommunicationRequest(CommunicationRequestModel o) {
    this.id = o.getId();
      ...
      this.payload = CommunicationRequestPayload.fromArray(o.getPayload());
      ...
      if (null != o.getRequester()) {
        this.requester = new CommunicationRequestRequester(o.getRequester());
  ...
  public static java.util.List<CommunicationRequest> fromArray(java.util.List<CommunicationRequestModel> list) {
    return (java.util.List<CommunicationRequest>)list.stream()
      .map(model -> new CommunicationRequest(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<CommunicationRequestModel> toModelArray(java.util.List<CommunicationRequest> list) {
    return (java.util.List<CommunicationRequestModel>)list.stream()
      .map(model -> new CommunicationRequestModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
