...
public class ClaimInsurance  {
  ...
  */
  ...
  public static java.util.List<ClaimInsurance> fromArray(java.util.List<ClaimInsuranceModel> list) {
    return (java.util.List<ClaimInsurance>)list.stream()
      .map(model -> new ClaimInsurance(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ClaimInsuranceModel> toModelArray(java.util.List<ClaimInsurance> list) {
    return (java.util.List<ClaimInsuranceModel>)list.stream()
      .map(model -> new ClaimInsuranceModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ClaimInsurance o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ClaimInsurance> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}