...
public class HealthcareServiceAvailableTime  {
  ...
  */
  ...
  public static java.util.List<HealthcareServiceAvailableTime> fromArray(java.util.List<HealthcareServiceAvailableTimeModel> list) {
    return (java.util.List<HealthcareServiceAvailableTime>)list.stream()
      .map(model -> new HealthcareServiceAvailableTime(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<HealthcareServiceAvailableTimeModel> toModelArray(java.util.List<HealthcareServiceAvailableTime> list) {
    return (java.util.List<HealthcareServiceAvailableTimeModel>)list.stream()
      .map(model -> new HealthcareServiceAvailableTimeModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
