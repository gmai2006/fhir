  ...
  */
  ...
  public EligibilityResponseBenefitBalance(EligibilityResponseBenefitBalanceModel o) {
    this.id = o.getId();
      ...
      this.financial = EligibilityResponseFinancial.fromArray(o.getFinancial());
  ...
  public static java.util.List<EligibilityResponseBenefitBalance> fromArray(java.util.List<EligibilityResponseBenefitBalanceModel> list) {
    return (java.util.List<EligibilityResponseBenefitBalance>)list.stream()
      .map(model -> new EligibilityResponseBenefitBalance(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<EligibilityResponseBenefitBalanceModel> toModelArray(java.util.List<EligibilityResponseBenefitBalance> list) {
    return (java.util.List<EligibilityResponseBenefitBalanceModel>)list.stream()
      .map(model -> new EligibilityResponseBenefitBalanceModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
