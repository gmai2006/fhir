...
public class TestScriptParam3  {
  ...
  */
  ...
  public static TestScriptParam3 fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, TestScriptParam3.class);
  }
  ...
  public static String toJson(TestScriptParam3 o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<TestScriptParam3> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
