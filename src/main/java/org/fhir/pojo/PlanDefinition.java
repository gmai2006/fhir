...
public class PlanDefinition  {
  ...
  */
  private java.util.List<PlanDefinitionGoal> goal = new java.util.ArrayList<>();
  ...
  */
  ...
  public PlanDefinition(PlanDefinitionModel o) {
    this.id = o.getId();
      ...
      this.goal = PlanDefinitionGoal.fromArray(o.getGoal());
  ...
  public static java.util.List<PlanDefinition> fromArray(java.util.List<PlanDefinitionModel> list) {
    return (java.util.List<PlanDefinition>)list.stream()
      .map(model -> new PlanDefinition(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<PlanDefinitionModel> toModelArray(java.util.List<PlanDefinition> list) {
    return (java.util.List<PlanDefinitionModel>)list.stream()
      .map(model -> new PlanDefinitionModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
