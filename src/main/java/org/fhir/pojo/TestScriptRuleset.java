...
*/
public class TestScriptRuleset  {
  /**
  ...
  */
  @javax.validation.constraints.NotNull
  private java.util.List<TestScriptRule1> rule = new java.util.ArrayList<>();
  ...
  */
  ...
  public static TestScriptRuleset fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, TestScriptRuleset.class);
  }
  ...
  public static String toJson(TestScriptRuleset o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<TestScriptRuleset> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
