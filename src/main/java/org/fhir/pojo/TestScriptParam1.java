...
public class TestScriptParam1  {
  ...
  */
  ...
  public static TestScriptParam1 fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, TestScriptParam1.class);
  }
  ...
  public static String toJson(TestScriptParam1 o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<TestScriptParam1> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
