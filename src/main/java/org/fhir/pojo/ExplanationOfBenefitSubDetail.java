...
public class ExplanationOfBenefitSubDetail  {
  ...
  */
  ...
  public static java.util.List<ExplanationOfBenefitSubDetail> fromArray(java.util.List<ExplanationOfBenefitSubDetailModel> list) {
    return (java.util.List<ExplanationOfBenefitSubDetail>)list.stream()
      .map(model -> new ExplanationOfBenefitSubDetail(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ExplanationOfBenefitSubDetailModel> toModelArray(java.util.List<ExplanationOfBenefitSubDetail> list) {
    return (java.util.List<ExplanationOfBenefitSubDetailModel>)list.stream()
      .map(model -> new ExplanationOfBenefitSubDetailModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ExplanationOfBenefitSubDetail o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ExplanationOfBenefitSubDetail> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}