...
public class TestScriptTest  {
  ...
  */
  ...
  private java.util.List<TestScriptAction1> action = new java.util.ArrayList<>();
  ...
  */
  ...
  public static TestScriptTest fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, TestScriptTest.class);
  }
  ...
  public static String toJson(TestScriptTest o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<TestScriptTest> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
