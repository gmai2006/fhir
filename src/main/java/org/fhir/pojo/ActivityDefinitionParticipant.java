...
public class ActivityDefinitionParticipant  {
  ...
  */
  ...
  public static java.util.List<ActivityDefinitionParticipant> fromArray(java.util.List<ActivityDefinitionParticipantModel> list) {
    return (java.util.List<ActivityDefinitionParticipant>)list.stream()
      .map(model -> new ActivityDefinitionParticipant(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ActivityDefinitionParticipantModel> toModelArray(java.util.List<ActivityDefinitionParticipant> list) {
    return (java.util.List<ActivityDefinitionParticipantModel>)list.stream()
      .map(model -> new ActivityDefinitionParticipantModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
