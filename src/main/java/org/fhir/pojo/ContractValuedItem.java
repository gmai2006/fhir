...
public class ContractValuedItem  {
  ...
  */
  ...
  public static java.util.List<ContractValuedItem> fromArray(java.util.List<ContractValuedItemModel> list) {
    return (java.util.List<ContractValuedItem>)list.stream()
      .map(model -> new ContractValuedItem(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ContractValuedItemModel> toModelArray(java.util.List<ContractValuedItem> list) {
    return (java.util.List<ContractValuedItemModel>)list.stream()
      .map(model -> new ContractValuedItemModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
