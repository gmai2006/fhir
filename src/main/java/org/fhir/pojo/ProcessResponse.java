...
public class ProcessResponse  {
  ...
  */
  private java.util.List<ProcessResponseProcessNote> processNote = new java.util.ArrayList<>();

  /**
  * Description: "Processing errors."
  */
  private java.util.List<CodeableConcept> error = new java.util.ArrayList<>();
  ...
  */
  ...
  public ProcessResponse(ProcessResponseModel o) {
    this.id = o.getId();
      ...
      this.processNote = ProcessResponseProcessNote.fromArray(o.getProcessNote());

      this.error = CodeableConcept.fromArray(o.getError());
  ...
  public static java.util.List<ProcessResponse> fromArray(java.util.List<ProcessResponseModel> list) {
    return (java.util.List<ProcessResponse>)list.stream()
      .map(model -> new ProcessResponse(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ProcessResponseModel> toModelArray(java.util.List<ProcessResponse> list) {
    return (java.util.List<ProcessResponseModel>)list.stream()
      .map(model -> new ProcessResponseModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ProcessResponse o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ProcessResponse> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}