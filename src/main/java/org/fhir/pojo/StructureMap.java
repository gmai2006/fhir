  ...
  */
  ...
  public String toString() {
    StringBuilder builder = new StringBuilder();
     ...
     builder.append("structure" + "[" + String.valueOf(this.structure) + "]\n"); 
     builder.append("FHIRimport" + "[" + String.valueOf(this.FHIRimport) + "]\n"); 
     builder.append("_import" + "[" + String.valueOf(this._import) + "]\n"); 
