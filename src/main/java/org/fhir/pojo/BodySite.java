...
public class BodySite  {
  ...
  */
  private java.util.List<CodeableConcept> qualifier = new java.util.ArrayList<>();
  ...
  */
  ...
  public BodySite(BodySiteModel o) {
    this.id = o.getId();
      ...
      this.qualifier = CodeableConcept.fromArray(o.getQualifier());
  ...
  public static java.util.List<BodySite> fromArray(java.util.List<BodySiteModel> list) {
    return (java.util.List<BodySite>)list.stream()
      .map(model -> new BodySite(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<BodySiteModel> toModelArray(java.util.List<BodySite> list) {
    return (java.util.List<BodySiteModel>)list.stream()
      .map(model -> new BodySiteModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
