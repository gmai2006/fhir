...
public class ContractFriendly  {
  ...
  */
  ...
  public static java.util.List<ContractFriendly> fromArray(java.util.List<ContractFriendlyModel> list) {
    return (java.util.List<ContractFriendly>)list.stream()
      .map(model -> new ContractFriendly(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ContractFriendlyModel> toModelArray(java.util.List<ContractFriendly> list) {
    return (java.util.List<ContractFriendlyModel>)list.stream()
      .map(model -> new ContractFriendlyModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ContractFriendly o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ContractFriendly> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}