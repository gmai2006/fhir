  ...
  */
  ...
  public ServiceDefinition(ServiceDefinitionModel o) {
    ...
    if (null != o.getTrigger() && !o.getTrigger().isEmpty()) {
    	this.trigger = TriggerDefinitionHelper.fromArray2Array(o.getTrigger());
    }
    ...
    if (null != o.getOperationDefinition() && !o.getOperationDefinition().isEmpty()) {
      this.operationDefinition = new Reference(o.getOperationDefinition().get(0));
    }
  ...
  public String toString() {
    ...
    builder.append("[ServiceDefinition]:" + "\n");
     ...
     if(this.trigger != null) builder.append("trigger" + "->" + this.trigger.toString() + "\n"); 
     if(this.dataRequirement != null) builder.append("dataRequirement" + "->" + this.dataRequirement.toString() + "\n"); 
     if(this.operationDefinition != null) builder.append("operationDefinition" + "->" + this.operationDefinition.toString() + "\n"); 
