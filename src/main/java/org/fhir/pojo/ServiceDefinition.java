...
public class ServiceDefinition  {
  ...
  */
  private java.util.List<TriggerDefinition> trigger = new java.util.ArrayList<>();
  ...
  */
  ...
  public ServiceDefinition(ServiceDefinitionModel o) {
    this.id = o.getId();
      ...
      this.trigger = TriggerDefinition.fromArray(o.getTrigger());

      this.dataRequirement = DataRequirement.fromArray(o.getDataRequirement());

      if (null != o.getOperationDefinition()) {
        this.operationDefinition = new Reference(o.getOperationDefinition());
        this.operationDefinition.setId(this.getId());
      }
  ...
  public void setTrigger( java.util.List<TriggerDefinition> value) {
    this.trigger = value;
  }
  ...
  public void setOperationDefinition( Reference value) {
  ...
  public String toString() {
    StringBuilder builder = new StringBuilder();
     ...
     builder.append("trigger" + "[" + String.valueOf(this.trigger) + "]\n"); 
     builder.append("dataRequirement" + "[" + String.valueOf(this.dataRequirement) + "]\n"); 
     builder.append("operationDefinition" + "[" + String.valueOf(this.operationDefinition) + "]\n"); 
  ...
  public enum ResourceTypeEnum {
  	...
  	public static String fromCode(String strVal) {
  		switch (strVal) {
  			case "ServiceDefinition" : { return ServiceDefinition.toString(); }
  			default:
  ...
  public static java.util.List<ServiceDefinition> fromArray(java.util.List<ServiceDefinitionModel> list) {
    return (java.util.List<ServiceDefinition>)list.stream()
      .map(model -> new ServiceDefinition(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ServiceDefinitionModel> toModelArray(java.util.List<ServiceDefinition> list) {
    return (java.util.List<ServiceDefinitionModel>)list.stream()
      .map(model -> new ServiceDefinitionModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
