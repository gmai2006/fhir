...
public class ValueSet  extends DomainResource  {
  ...
  */
  protected transient Element _immutable;
  ...
  */
  protected transient Element _extensible;
  ...
  */
  ...
  public ValueSet(ValueSetModel o) {
    ...
    if (null != o.getCompose() && !o.getCompose().isEmpty()) {
      this.compose = new ValueSetCompose(o.getCompose().get(0));
    }
    if (null != o.getExpansion() && !o.getExpansion().isEmpty()) {
      this.expansion = new ValueSetExpansion(o.getExpansion().get(0));
    }
  }
  ...
  public String toString() {
    ...
    builder.append("[ValueSet]:" + "\n");
     ...
     if(this.immutable != null) builder.append("immutable" + "->" + this.immutable.toString() + "\n"); 
     if(this._immutable != null) builder.append("_immutable" + "->" + this._immutable.toString() + "\n"); 
     ...
     if(this.extensible != null) builder.append("extensible" + "->" + this.extensible.toString() + "\n"); 
     if(this._extensible != null) builder.append("_extensible" + "->" + this._extensible.toString() + "\n"); 
     if(this.compose != null) builder.append("compose" + "->" + this.compose.toString() + "\n"); 
     if(this.expansion != null) builder.append("expansion" + "->" + this.expansion.toString() + "\n"); ;
