...
public class ValueSet  {
  ...
  */
  private transient Element _immutable;
  ...
  */
  private transient Element _extensible;
  ...
  */
  ...
  public ValueSet(ValueSetModel o) {
    this.id = o.getId();
      ...
      if (null != o.getImmutable()) {
        this.immutable = new Boolean(o.getImmutable());
      }
      ...
      if (null != o.getExtensible()) {
        this.extensible = new Boolean(o.getExtensible());
      }

      if (null != o.getCompose()) {
        this.compose = new ValueSetCompose(o.getCompose());
        this.compose.setId(this.getId());
      }

      if (null != o.getExpansion()) {
        this.expansion = new ValueSetExpansion(o.getExpansion());
        this.expansion.setId(this.getId());
      }
  ...
  public void set_immutable( Element value) {
    this._immutable = value;
  }
  public Element get_immutable() {
  ...
  public void set_extensible( Element value) {
    this._extensible = value;
  }
  public Element get_extensible() {
  ...
  public String toString() {
    StringBuilder builder = new StringBuilder();
     ...
     builder.append("immutable" + "[" + String.valueOf(this.immutable) + "]\n"); 
     builder.append("_immutable" + "[" + String.valueOf(this._immutable) + "]\n"); 
     ...
     builder.append("extensible" + "[" + String.valueOf(this.extensible) + "]\n"); 
     builder.append("_extensible" + "[" + String.valueOf(this._extensible) + "]\n"); 
     builder.append("compose" + "[" + String.valueOf(this.compose) + "]\n"); 
     builder.append("expansion" + "[" + String.valueOf(this.expansion) + "]\n"); 
  ...
  public enum ResourceTypeEnum {
  	...
  	public static String fromCode(String strVal) {
  		switch (strVal) {
  			case "ValueSet" : { return ValueSet.toString(); }
  			default:
  ...
  public static java.util.List<ValueSet> fromArray(java.util.List<ValueSetModel> list) {
    return (java.util.List<ValueSet>)list.stream()
      .map(model -> new ValueSet(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ValueSetModel> toModelArray(java.util.List<ValueSet> list) {
    return (java.util.List<ValueSetModel>)list.stream()
      .map(model -> new ValueSetModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
