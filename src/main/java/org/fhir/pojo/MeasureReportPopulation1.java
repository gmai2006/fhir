...
public class MeasureReportPopulation1  {
  ...
  */
  ...
  public static java.util.List<MeasureReportPopulation1> fromArray(java.util.List<MeasureReportPopulation1Model> list) {
    return (java.util.List<MeasureReportPopulation1>)list.stream()
      .map(model -> new MeasureReportPopulation1(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<MeasureReportPopulation1Model> toModelArray(java.util.List<MeasureReportPopulation1> list) {
    return (java.util.List<MeasureReportPopulation1Model>)list.stream()
      .map(model -> new MeasureReportPopulation1Model(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(MeasureReportPopulation1 o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<MeasureReportPopulation1> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}