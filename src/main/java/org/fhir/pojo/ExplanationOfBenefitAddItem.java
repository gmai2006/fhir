  ...
  */
  ...
  public ExplanationOfBenefitAddItem(ExplanationOfBenefitAddItemModel o) {
    this.id = o.getId();
      ...
      this.detail = ExplanationOfBenefitDetail1.fromArray(o.getDetail());
  ...
  public static java.util.List<ExplanationOfBenefitAddItem> fromArray(java.util.List<ExplanationOfBenefitAddItemModel> list) {
    return (java.util.List<ExplanationOfBenefitAddItem>)list.stream()
      .map(model -> new ExplanationOfBenefitAddItem(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ExplanationOfBenefitAddItemModel> toModelArray(java.util.List<ExplanationOfBenefitAddItem> list) {
    return (java.util.List<ExplanationOfBenefitAddItemModel>)list.stream()
      .map(model -> new ExplanationOfBenefitAddItemModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
