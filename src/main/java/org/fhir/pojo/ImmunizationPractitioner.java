...
*/
public class ImmunizationPractitioner  {
  /**
  ...
  */
  ...
  public static java.util.List<ImmunizationPractitioner> fromArray(java.util.List<ImmunizationPractitionerModel> list) {
    return (java.util.List<ImmunizationPractitioner>)list.stream()
      .map(model -> new ImmunizationPractitioner(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ImmunizationPractitionerModel> toModelArray(java.util.List<ImmunizationPractitioner> list) {
    return (java.util.List<ImmunizationPractitionerModel>)list.stream()
      .map(model -> new ImmunizationPractitionerModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
