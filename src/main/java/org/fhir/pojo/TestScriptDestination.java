...
public class TestScriptDestination  {
  ...
  */
  private transient Element _index;
  ...
  */
  ...
  public String toString() {
    StringBuilder builder = new StringBuilder();
     builder.append("index" + "[" + String.valueOf(this.index) + "]\n"); 
     builder.append("_index" + "[" + String.valueOf(this._index) + "]\n"); 
  ...
  public static TestScriptDestination fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, TestScriptDestination.class);
  }
  ...
  public static String toJson(TestScriptDestination o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<TestScriptDestination> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
