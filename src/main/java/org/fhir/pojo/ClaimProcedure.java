...
public class ClaimProcedure  {
  ...
  */
  ...
  public static java.util.List<ClaimProcedure> fromArray(java.util.List<ClaimProcedureModel> list) {
    return (java.util.List<ClaimProcedure>)list.stream()
      .map(model -> new ClaimProcedure(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ClaimProcedureModel> toModelArray(java.util.List<ClaimProcedure> list) {
    return (java.util.List<ClaimProcedureModel>)list.stream()
      .map(model -> new ClaimProcedureModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ClaimProcedure o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ClaimProcedure> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}