...
public class Substance  {
  ...
  */
  private java.util.List<SubstanceInstance> instance = new java.util.ArrayList<>();

  /**
  * Description: "A substance can be composed of other substances."
  */
  private java.util.List<SubstanceIngredient> ingredient = new java.util.ArrayList<>();
