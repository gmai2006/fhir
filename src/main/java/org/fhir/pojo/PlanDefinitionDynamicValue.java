...
public class PlanDefinitionDynamicValue  {
  ...
  */
  ...
  public PlanDefinitionDynamicValue() {
  }

  public PlanDefinitionDynamicValue(PlanDefinitionDynamicValueModel o) {
    this.id = o.getId();
  ...
  public static java.util.List<PlanDefinitionDynamicValue> fromArray(java.util.List<PlanDefinitionDynamicValueModel> list) {
    return (java.util.List<PlanDefinitionDynamicValue>)list.stream()
      .map(model -> new PlanDefinitionDynamicValue(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<PlanDefinitionDynamicValueModel> toModelArray(java.util.List<PlanDefinitionDynamicValue> list) {
    return (java.util.List<PlanDefinitionDynamicValueModel>)list.stream()
      .map(model -> new PlanDefinitionDynamicValueModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
