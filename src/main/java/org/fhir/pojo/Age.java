...
public class Age  {
  ...
  */
  ...
  public static Age fromJson(String json) {
    if (null == json) return null;
    return new GsonBuilder().create().fromJson(json, Age.class);
  }
  ...
  public static String toJson(Age o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<Age> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
