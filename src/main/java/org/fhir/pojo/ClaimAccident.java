...
public class ClaimAccident  {
  ...
  */
  ...
  public static java.util.List<ClaimAccident> fromArray(java.util.List<ClaimAccidentModel> list) {
    return (java.util.List<ClaimAccident>)list.stream()
      .map(model -> new ClaimAccident(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<ClaimAccidentModel> toModelArray(java.util.List<ClaimAccident> list) {
    return (java.util.List<ClaimAccidentModel>)list.stream()
      .map(model -> new ClaimAccidentModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
  ...
  public static String toJson(ClaimAccident o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }

  public static String toJson(java.util.List<ClaimAccident> o) {
    if (null == o) return null;
    return new GsonBuilder().create().toJson(o);
  }
}