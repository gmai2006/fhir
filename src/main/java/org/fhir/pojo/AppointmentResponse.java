  ...
  */
  ...
  public AppointmentResponse(AppointmentResponseModel o) {
    this.id = o.getId();
      ...
      this.participantType = CodeableConcept.fromArray(o.getParticipantType());
      if (null != o.getActor()) {
      ...
      if (null != o.getParticipantStatus()) {
        this.participantStatus = new String(o.getParticipantStatus());
      }
  ...
  public String toString() {
    StringBuilder builder = new StringBuilder();
     ...
     builder.append("_participantStatus" + "[" + String.valueOf(this._participantStatus) + "]\n"); 
  ...
  public static java.util.List<AppointmentResponse> fromArray(java.util.List<AppointmentResponseModel> list) {
    return (java.util.List<AppointmentResponse>)list.stream()
      .map(model -> new AppointmentResponse(model))
      .collect(java.util.stream.Collectors.toList());
  }

  public static java.util.List<AppointmentResponseModel> toModelArray(java.util.List<AppointmentResponse> list) {
    return (java.util.List<AppointmentResponseModel>)list.stream()
      .map(model -> new AppointmentResponseModel(model))
      .collect(java.util.stream.Collectors.toList());
  }
