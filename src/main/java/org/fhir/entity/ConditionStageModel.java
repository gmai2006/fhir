...
public class ConditionStageModel  {
  /**
  ...
  */
  ...
  private java.util.List<ReferenceModel> assessment = new java.util.ArrayList<>();
  ...
  */
  ...
  public ConditionStageModel(ConditionStage o) {
    this.id = o.getId();
      this.summary = CodeableConcept.toJson(o.getSummary());
      this.assessment = Reference.toModelArray(o.getAssessment());
