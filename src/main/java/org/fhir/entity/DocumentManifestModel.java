...
public class DocumentManifestModel  {
  /**
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<DocumentManifestContentModel> content = new java.util.ArrayList<>();
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<DocumentManifestRelatedModel> related = new java.util.ArrayList<>();
  ...
  */
  ...
  public DocumentManifestModel(DocumentManifest o) {
    this.id = o.getId();
      ...
      this.content = DocumentManifestContent.toModelArray(o.getContent());

      this.related = DocumentManifestRelated.toModelArray(o.getRelated());
