...
public class TestReportTestModel  implements Serializable {
	private static final long serialVersionUID = 151857669664421048L;
  /**
  ...
  */
  ...
  public java.util.List<TestReportAction1Model> getAction() {
    return this.action;
  }
  public void setAction( java.util.List<TestReportAction1Model> value) {
    this.action = value;
  }
  ...
  public String toString() {
    ...
    builder.append("[TestReportTestModel]:" + "\n");
