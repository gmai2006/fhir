...
public class MedicationPackageModel  {
  /**
  ...
  */
  ...
  private java.util.List<MedicationContentModel> content = new java.util.ArrayList<>();
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<MedicationBatchModel> batch = new java.util.ArrayList<>();
  ...
  */
  ...
  public MedicationPackageModel(MedicationPackage o) {
    this.id = o.getId();
      this.container = CodeableConcept.toJson(o.getContainer());
      this.content = MedicationContent.toModelArray(o.getContent());

      this.batch = MedicationBatch.toModelArray(o.getBatch());
