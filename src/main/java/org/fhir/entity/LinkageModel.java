...
public class LinkageModel  implements Serializable {
	private static final long serialVersionUID = 151857669675897212L;
  /**
  ...
  */
  ...
  private java.util.List<LinkageItemModel> item;
  ...
  */
  ...
  public LinkageModel(Linkage o) {
    ...
    if (null != o.getItem() && !o.getItem().isEmpty()) {
    	...
    	this.item = LinkageItemHelper.toModelFromArray(o.getItem(), this.item_id);
    }
    if (null != o.getText() ) {
  ...
  public java.util.List<LinkageItemModel> getItem() {
    return this.item;
  }
  public void setItem( java.util.List<LinkageItemModel> value) {
    this.item = value;
  }
