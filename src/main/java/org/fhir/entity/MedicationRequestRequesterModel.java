...
public class MedicationRequestRequesterModel  implements Serializable {
	private static final long serialVersionUID = 151910893762464988L;
  /**
  ...
  */
  ...
  public MedicationRequestRequesterModel() {
  }

  public MedicationRequestRequesterModel(MedicationRequestRequester o, String parentId) {
