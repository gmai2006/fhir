...
public class ValueSetModel  {
  ...
  */
  ...
  @javax.persistence.JoinColumn(name = "`compose_id`", insertable=false, updatable=false)
  private ValueSetComposeModel compose;
  ...
  */
  ...
  @javax.persistence.OneToOne(cascade = {javax.persistence.CascadeType.ALL}, fetch = javax.persistence.FetchType.LAZY)
  @javax.persistence.JoinColumn(name = "`expansion_id`", insertable=false, updatable=false)
  private ValueSetExpansionModel expansion;
  ...
  */
  ...
  public ValueSetModel(ValueSet o) {
    this.id = o.getId();
      ...
      if (null != o.getCompose()) {
      	this.compose_id = "compose" + this.getId();
        this.compose = new ValueSetComposeModel(o.getCompose());
        this.compose.setId(this.compose_id);
        this.compose.parent_id = this.compose.getId();
      }

      if (null != o.getExpansion()) {
      	this.expansion_id = "expansion" + this.getId();
        this.expansion = new ValueSetExpansionModel(o.getExpansion());
        this.expansion.setId(this.expansion_id);
        this.expansion.parent_id = this.expansion.getId();
      }
  ...
  public void setCompose( ValueSetComposeModel value) {
    this.compose = value;
  }
  public ValueSetComposeModel getCompose() {
    return this.compose;
  }
  public void setExpansion( ValueSetExpansionModel value) {
    this.expansion = value;
  }
  public ValueSetExpansionModel getExpansion() {
