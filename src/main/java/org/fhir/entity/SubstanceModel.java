...
public class SubstanceModel  {
  ...
  */
  ...
  private java.util.List<SubstanceInstanceModel> instance = new java.util.ArrayList<>();
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<SubstanceIngredientModel> ingredient = new java.util.ArrayList<>();
  ...
  */
  ...
  public SubstanceModel(Substance o) {
    this.id = o.getId();
      ...
      this.instance = SubstanceInstance.toModelArray(o.getInstance());

      this.ingredient = SubstanceIngredient.toModelArray(o.getIngredient());
