...
public class CapabilityStatementEndpointModel  {
  /**
  ...
  */
  ...
  public CapabilityStatementEndpointModel() {
  }

  public CapabilityStatementEndpointModel(CapabilityStatementEndpoint o) {
    this.id = o.getId();
      this.protocol = Coding.toJson(o.getProtocol());
