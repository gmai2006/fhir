...
public class DeviceRequestModel  implements Serializable {
	private static final long serialVersionUID = 153159210139941631L;
  /**
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="priorrequest_id", insertable=false, updatable=false)
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="intent_id", insertable=false, updatable=false)
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="codereference_id", insertable=false, updatable=false)
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="codecodeableconcept_id", insertable=false, updatable=false)
