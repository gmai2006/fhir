...
public class CompartmentDefinitionModel  {
  /**
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<CompartmentDefinitionResourceModel> resource = new java.util.ArrayList<>();
  ...
  */
  ...
  public CompartmentDefinitionModel(CompartmentDefinition o) {
    this.id = o.getId();
      ...
      this.resource = CompartmentDefinitionResource.toModelArray(o.getResource());
