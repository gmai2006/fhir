...
public class CompartmentDefinitionModel  implements Serializable {
	private static final long serialVersionUID = 151910893736155497L;
  /**
  ...
  */
  ...
  private java.util.List<CompartmentDefinitionResourceModel> resource;
  ...
  */
  ...
  public CompartmentDefinitionModel() {
  }

  public CompartmentDefinitionModel(CompartmentDefinition o) {
  	this.id = o.getId();
    ...
    this.code = o.getCode();
    this.search = o.getSearch();
    if (null != o.getResource() && !o.getResource().isEmpty()) {
    	this.resource_id = "resource" + this.id;
    	this.resource = CompartmentDefinitionResourceHelper.toModelFromArray(o.getResource(), this.resource_id);
    }
    if (null != o.getText() ) {
  ...
  public java.util.List<CompartmentDefinitionResourceModel> getResource() {
    return this.resource;
  }
  public void setResource( java.util.List<CompartmentDefinitionResourceModel> value) {
    this.resource = value;
  }
  ...
  public String toString() {
    ...
    builder.append("[CompartmentDefinitionModel]:" + "\n");
