...
public class ExplanationOfBenefitAddItemModel  {
  /**
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<ExplanationOfBenefitDetail1Model> detail = new java.util.ArrayList<>();
  ...
  */
  ...
  public ExplanationOfBenefitAddItemModel(ExplanationOfBenefitAddItem o) {
    this.id = o.getId();
      ...
      this.detail = ExplanationOfBenefitDetail1.toModelArray(o.getDetail());
  ...
  public void setDetail( java.util.List<ExplanationOfBenefitDetail1Model> value) {
    this.detail = value;
  }
  public java.util.List<ExplanationOfBenefitDetail1Model> getDetail() {
    return this.detail;
  }
