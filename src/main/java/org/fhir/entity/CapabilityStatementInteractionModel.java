...
*/
@Entity
@Table(name="capabilitystatementinteraction")
public class CapabilityStatementInteractionModel  implements Serializable {
	private static final long serialVersionUID = 153159210222282253L;
  /**
  ...
  */
  ...
  public CapabilityStatementInteractionModel() {
  }

  public CapabilityStatementInteractionModel(CapabilityStatementInteraction o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[CapabilityStatementInteractionModel]:" + "\n");
