...
public class ValueSetFilterModel  implements Serializable {
	private static final long serialVersionUID = 153159210152489439L;
  /**
  ...
  */
  ...
  public ValueSetFilterModel() {
  }

  public ValueSetFilterModel(ValueSetFilter o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[ValueSetFilterModel]:" + "\n");
     builder.append("property" + "->" + this.property + "\n"); 
     builder.append("op" + "->" + this.op + "\n"); 
