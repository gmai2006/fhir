...
public class DocumentReferenceContentModel  {
  /**
  ...
  */
  ...
  public DocumentReferenceContentModel(DocumentReferenceContent o) {
    this.id = o.getId();
      this.attachment = Attachment.toJson(o.getAttachment());
      this.format = Coding.toJson(o.getFormat());
