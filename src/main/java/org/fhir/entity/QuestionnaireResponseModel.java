...
public class QuestionnaireResponseModel  {
  ...
  */
  ...
  @javax.persistence.JoinColumn(name = "`questionnaire_id`", insertable=false, updatable=false)
  private ReferenceModel questionnaire;
  ...
  */
  ...
  public QuestionnaireResponseModel(QuestionnaireResponse o) {
    this.id = o.getId();
      ...
      if (null != o.getQuestionnaire()) {
      	this.questionnaire_id = "questionnaire" + this.getId();
        this.questionnaire = new ReferenceModel(o.getQuestionnaire());
        this.questionnaire.setId(this.questionnaire_id);
        this.questionnaire.parent_id = this.questionnaire.getId();
      }
  ...
  public void setQuestionnaire( ReferenceModel value) {
    this.questionnaire = value;
  }
  public ReferenceModel getQuestionnaire() {
