...
public class QuestionnaireResponseModel  implements Serializable {
	private static final long serialVersionUID = 151967883227968567L;
  /**
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="questionnaire_id", insertable=false, updatable=false)
  private java.util.List<ReferenceModel> questionnaire;
  ...
  */
  ...
  public QuestionnaireResponseModel(QuestionnaireResponse o) {
    ...
    if (null != o.getQuestionnaire() ) {
    	this.questionnaire_id = "questionnaire" + this.id;
    	this.questionnaire = ReferenceHelper.toModel(o.getQuestionnaire(), this.questionnaire_id);
    }
  ...
  public java.util.List<ReferenceModel> getQuestionnaire() {
    return this.questionnaire;
  }
  public void setQuestionnaire( java.util.List<ReferenceModel> value) {
  ...
  public String toString() {
    ...
    builder.append("[QuestionnaireResponseModel]:" + "\n");
     builder.append("resourceType" + "->" + this.resourceType + "\n"); 
     builder.append("identifier" + "->" + this.identifier + "\n"); 
     builder.append("status" + "->" + this.status + "\n"); 
     builder.append("authored" + "->" + this.authored + "\n"); 
  ...
  public String debug() {
    ...
    builder.append("[QuestionnaireResponseModel]:" + "\n");
     ...
     builder.append("questionnaire" + "->" + this.questionnaire + "\n"); 
     builder.append("status" + "->" + this.status + "\n"); 
