...
public class ExpansionProfileDesignationModel  implements Serializable {
  ...
  */
  ...
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="include_id", insertable=false, updatable=false)
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="exclude_id", insertable=false, updatable=false)
  ...
  */
  ...
  public ExpansionProfileDesignationModel(ExpansionProfileDesignation o, String containerId) {
  	this.db_container_id = containerId;
  	if (null == this.id) {
  		this.id = String.valueOf(System.nanoTime() + org.fhir.utils.EntityUtils.generateRandomString(10));
  	}
    if (null != o.getInclude() ) {
    	this.include_id = "include" + this.id;
    	this.include = ExpansionProfileIncludeHelper.toModel(o.getInclude(), this.include_id);
    }
    if (null != o.getExclude() ) {
    	this.exclude_id = "exclude" + this.id;
