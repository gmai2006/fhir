...
public class MedicationDispenseSubstitutionModel  {
  /**
  ...
  */
  ...
  private java.util.List<ReferenceModel> responsibleParty = new java.util.ArrayList<>();
  ...
  */
  ...
  public MedicationDispenseSubstitutionModel(MedicationDispenseSubstitution o) {
    this.id = o.getId();
      ...
      this.responsibleParty = Reference.toModelArray(o.getResponsibleParty());
