...
public class MessageDefinitionAllowedResponseModel  implements Serializable {
  ...
  */
  ...
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="message_id", insertable=false, updatable=false)
  ...
  */
  ...
  public MessageDefinitionAllowedResponseModel(MessageDefinitionAllowedResponse o, String containerId) {
  	this.db_container_id = containerId;
  	if (null == this.id) {
  		this.id = String.valueOf(System.nanoTime() + org.fhir.utils.EntityUtils.generateRandomString(10));
  	}
    if (null != o.getMessage() ) {
    	this.message_id = "message" + this.id;
