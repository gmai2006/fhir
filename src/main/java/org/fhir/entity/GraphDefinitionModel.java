...
public class GraphDefinitionModel  implements Serializable {
	private static final long serialVersionUID = 151967883182857109L;
  /**
  ...
  */
  ...
  public GraphDefinitionModel() {
  }

  public GraphDefinitionModel(GraphDefinition o) {
  	this.id = o.getId();
  ...
  public String toString() {
    ...
    builder.append("[GraphDefinitionModel]:" + "\n");
