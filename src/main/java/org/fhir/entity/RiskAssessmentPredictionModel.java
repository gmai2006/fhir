...
public class RiskAssessmentPredictionModel  implements Serializable {
  ...
  */
  ...
  @javax.persistence.OneToMany(cascade = javax.persistence.CascadeType.ALL)
  @javax.persistence.JoinColumn(name = "\"db_container_id\"", referencedColumnName="qualitativerisk_id", insertable=false, updatable=false)
  ...
  */
  ...
  public RiskAssessmentPredictionModel(RiskAssessmentPrediction o, String containerId) {
    ...
    if (null != o.getQualitativeRisk() ) {
    	this.qualitativerisk_id = "qualitativerisk" + this.id;
