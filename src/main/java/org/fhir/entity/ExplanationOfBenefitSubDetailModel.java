...
*/
@Entity
@Table(name="explanationofbenefitsubdetail")
public class ExplanationOfBenefitSubDetailModel  implements Serializable {
	private static final long serialVersionUID = 153159210145620423L;
  /**
  ...
  */
  ...
  public ExplanationOfBenefitSubDetailModel() {
  }

  public ExplanationOfBenefitSubDetailModel(ExplanationOfBenefitSubDetail o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[ExplanationOfBenefitSubDetailModel]:" + "\n");
