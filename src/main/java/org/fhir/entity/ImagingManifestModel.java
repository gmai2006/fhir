...
public class ImagingManifestModel  implements Serializable {
	private static final long serialVersionUID = 151857669667158466L;
  /**
  ...
  */
  ...
  @javax.persistence.Basic
  @Column(name="\"authoringTime\"")
  private String authoringTime;
  ...
  */
  ...
  private java.util.List<ImagingManifestStudyModel> study;
  ...
  */
  ...
  public ImagingManifestModel() {
  }

  public ImagingManifestModel(ImagingManifest o) {
  	this.id = o.getId();
    ...
    if (null != o.getStudy() && !o.getStudy().isEmpty()) {
    	...
    	this.study = ImagingManifestStudyHelper.toModelFromArray(o.getStudy(), this.study_id);
    }
    if (null != o.getText() ) {
  ...
  public java.util.List<ImagingManifestStudyModel> getStudy() {
    return this.study;
  }
  public void setStudy( java.util.List<ImagingManifestStudyModel> value) {
    this.study = value;
  }
