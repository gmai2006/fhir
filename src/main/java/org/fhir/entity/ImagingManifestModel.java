...
public class ImagingManifestModel  {
  /**
  ...
  */
  ...
  private java.util.List<ImagingManifestStudyModel> study = new java.util.ArrayList<>();
  ...
  */
  ...
  public ImagingManifestModel(ImagingManifest o) {
    this.id = o.getId();
      ...
      this.study = ImagingManifestStudy.toModelArray(o.getStudy());
