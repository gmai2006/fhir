...
*/
@Entity
@Table(name="capabilitystatementoperation")
public class CapabilityStatementOperationModel  implements Serializable {
	private static final long serialVersionUID = 153159210181350431L;
  /**
  ...
  */
  ...
  public CapabilityStatementOperationModel() {
  }

  public CapabilityStatementOperationModel(CapabilityStatementOperation o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[CapabilityStatementOperationModel]:" + "\n");
