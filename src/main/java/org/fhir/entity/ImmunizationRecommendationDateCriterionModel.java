...
public class ImmunizationRecommendationDateCriterionModel  {
  /**
  ...
  */
  ...
  public ImmunizationRecommendationDateCriterionModel(ImmunizationRecommendationDateCriterion o) {
    this.id = o.getId();
