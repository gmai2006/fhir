...
public class ImplementationGuidePackageModel  {
  /**
  ...
  */
  ...
  private java.util.List<ImplementationGuideResourceModel> resource = new java.util.ArrayList<>();
  ...
  */
  ...
  public ImplementationGuidePackageModel(ImplementationGuidePackage o) {
    this.id = o.getId();
      this.name = o.getName();

      this.description = o.getDescription();

      this.resource = ImplementationGuideResource.toModelArray(o.getResource());
