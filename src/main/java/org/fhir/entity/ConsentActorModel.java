...
*/
@Entity
@Table(name="consentactor")
public class ConsentActorModel  implements Serializable {
	private static final long serialVersionUID = 153159210191135392L;
  /**
  ...
  */
  ...
  public ConsentActorModel() {
  }

  public ConsentActorModel(ConsentActor o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[ConsentActorModel]:" + "\n");
