...
*/
@Entity
@Table(name="imagingmanifestinstance")
public class ImagingManifestInstanceModel  implements Serializable {
	private static final long serialVersionUID = 151967883196729657L;
  /**
  ...
  */
  ...
  public ImagingManifestInstanceModel() {
  }

  public ImagingManifestInstanceModel(ImagingManifestInstance o, String containerId) {
  ...
  public String toString() {
    ...
    builder.append("[ImagingManifestInstanceModel]:" + "\n");
