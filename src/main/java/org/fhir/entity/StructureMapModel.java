...
public class StructureMapModel  implements Serializable {
  ...
  */
  @javax.persistence.Basic
  @Column(name="\"FHIRimport\"")
  private String FHIRimport;
  ...
  */
  ...
  public StructureMapModel() {
  }

  public StructureMapModel(StructureMap o) {
  	this.id = o.getId();
    ...
    if (null != o.getStructure() && !o.getStructure().isEmpty()) {
    	this.structure_id = "structure" + this.id;
    	this.structure = StructureMapStructureHelper.toModelFromArray(o.getStructure(), this.structure_id);
    }
    this.FHIRimport = org.fhir.utils.JsonUtils.write2String(o.getFHIRimport());
    if (null != o.getGroup() && !o.getGroup().isEmpty()) {
    	this.group_id = "group" + this.id;
    	this.group = StructureMapGroupHelper.toModelFromArray(o.getGroup(), this.group_id);
    }
    if (null != o.getText() ) {
  ...
  public java.util.List<StructureMapStructureModel> getStructure() {
    return this.structure;
  }
  public void setStructure( java.util.List<StructureMapStructureModel> value) {
    this.structure = value;
  }
  public String getFHIRimport() {
    return this.FHIRimport;
  }
  public void setFHIRimport( String value) {
    this.FHIRimport = value;
  }
  public java.util.List<StructureMapGroupModel> getGroup() {
    return this.group;
  }
  public void setGroup( java.util.List<StructureMapGroupModel> value) {
    this.group = value;
  }
  ...
  public String toString() {
    ...
    builder.append("[StructureMapModel]:" + "\n");
     ...
     builder.append("FHIRimport" + "->" + this.FHIRimport + "\n"); 
