...
public class ServiceDefinitionModel  {
  ...
  */
  @javax.persistence.OneToMany
  @javax.persistence.JoinColumn(name = "parent_id", referencedColumnName="id", insertable=false, updatable=false)
  private java.util.List<TriggerDefinitionModel> trigger = new java.util.ArrayList<>();
  ...
  */
  ...
  @javax.persistence.JoinColumn(name = "`operationdefinition_id`", insertable=false, updatable=false)
  private ReferenceModel operationDefinition;
  ...
  */
  ...
  public ServiceDefinitionModel(ServiceDefinition o) {
    this.id = o.getId();
      ...
      this.trigger = TriggerDefinition.toModelArray(o.getTrigger());

      this.dataRequirement = DataRequirement.toModelArray(o.getDataRequirement());

      if (null != o.getOperationDefinition()) {
      	this.operationdefinition_id = "operationDefinition" + this.getId();
        this.operationDefinition = new ReferenceModel(o.getOperationDefinition());
        this.operationDefinition.setId(this.operationdefinition_id);
        this.operationDefinition.parent_id = this.operationDefinition.getId();
      }
  ...
  public void setOperationDefinition( ReferenceModel value) {
    this.operationDefinition = value;
  }
  public ReferenceModel getOperationDefinition() {
