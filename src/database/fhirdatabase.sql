...
CREATE TABLE `dosage` (
 ...
 `dosesimplequantity_id` VARCHAR(64),
 `maxdoseperadministration_id` VARCHAR(64),
 `maxdoseperlifetime_id` VARCHAR(64),
 `ratesimplequantity_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `composition` (
 ...
 `attester_id` VARCHAR(64),
 `custodian_id` VARCHAR(64),
 `relatesto_id` VARCHAR(64),
 `event_id` VARCHAR(64),
...
CREATE TABLE `nutritionorderenteralformula` (
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `caloricdensity_id` VARCHAR(64),
 `administration_id` VARCHAR(64),
 `maxvolumetodeliver_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `explanationofbenefit` (
 ...
 `payee_id` VARCHAR(64),
 `information_id` VARCHAR(64),
 `careteam_id` VARCHAR(64),
 `diagnosis_id` VARCHAR(64),
 `procedure_id` VARCHAR(64),
 `insurance_id` VARCHAR(64),
 `accident_id` VARCHAR(64),
 `item_id` VARCHAR(64),
 `additem_id` VARCHAR(64),
 `totalcost_id` VARCHAR(64),
 `unallocdeductable_id` VARCHAR(64),
 `totalbenefit_id` VARCHAR(64),
 `payment_id` VARCHAR(64),
 `processnote_id` VARCHAR(64),
 `benefitbalance_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `testreport` (
 ...
 `implicitRules` VARCHAR(1024),
 `language` VARCHAR(1024),
 `testscript_id` VARCHAR(64),
 `participant_id` VARCHAR(64),
 `setup_id` VARCHAR(64),
 `test_id` VARCHAR(64),
 `teardown_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `encounter` (
 ...
 `language` VARCHAR(1024),
 `statushistory_id` VARCHAR(64),
 `classhistory_id` VARCHAR(64),
 `subject_id` VARCHAR(64),
 `episodeofcare_id` VARCHAR(64),
 `incomingreferral_id` VARCHAR(64),
 `participant_id` VARCHAR(64),
...
CREATE TABLE `allergyintolerancereaction` (
 ...
 `manifestation` MEDIUMTEXT NOT NULL,
 `description` MEDIUMTEXT,
 `onset` VARCHAR(1024),
...
CREATE TABLE `guidanceresponse` (
 ...
 `performer_id` VARCHAR(64),
 `reasonreference_id` VARCHAR(64),
 `evaluationmessage_id` VARCHAR(64),
 `outputparameters_id` VARCHAR(64),
 `result_id` VARCHAR(64),
 `datarequirement_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `patient` (
 ...
 `generalpractitioner_id` VARCHAR(64),
 `managingorganization_id` VARCHAR(64),
 `link_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
...
CREATE TABLE `datarequirement` (
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `codefilter_id` VARCHAR(64),
 `datefilter_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `specimencontainer` (
 ...
 `specimenquantity_id` VARCHAR(64),
...
CREATE TABLE `capabilitystatementmessaging` (
 ...
 `parent_id` VARCHAR(64) NOT NULL,
 `endpoint_id` VARCHAR(64),
 `supportedmessage_id` VARCHAR(64),
 `event_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `medicationdispense` (
 ...
 `supportinginformation_id` VARCHAR(64),
 `performer_id` VARCHAR(64),
 `authorizingprescription_id` VARCHAR(64),
 `quantity_id` VARCHAR(64),
 `dayssupply_id` VARCHAR(64),
 `destination_id` VARCHAR(64),
 `receiver_id` VARCHAR(64),
 `dosageinstruction_id` VARCHAR(64),
 `substitution_id` VARCHAR(64),
...
CREATE TABLE `nutritionorder` (
 ...
 `allergyintolerance_id` VARCHAR(64),
 `oraldiet_id` VARCHAR(64),
 `supplement_id` VARCHAR(64),
...
CREATE TABLE `fhirprocedure` (
 ...
 `complicationdetail_id` VARCHAR(64),
 `focaldevice_id` VARCHAR(64),
 `usedreference_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `immunizationvaccinationprotocol` (
 ...
 `series` VARCHAR(1024),
 `seriesDoses` FLOAT,
 `targetDisease` MEDIUMTEXT NOT NULL,
 `doseStatus` MEDIUMTEXT NOT NULL,
...
CREATE TABLE `medicationdispensesubstitution` (
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `responsibleparty_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `clinicalimpression` (
 ...
 `prognosisreference_id` VARCHAR(64),
 `action_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
...
CREATE TABLE `structuremapsource` (
 ...
 `defaultValueCodeableConcept` MEDIUMTEXT,
 `defaultValueCoding` MEDIUMTEXT,
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `defaultvaluenarrative_id` VARCHAR(64),
 `defaultvaluequantity_id` VARCHAR(64),
 `defaultvaluesimplequantity_id` VARCHAR(64),
 `defaultvaluedistance_id` VARCHAR(64),
 `defaultvaluemoney_id` VARCHAR(64),
 `defaultvaluereference_id` VARCHAR(64),
 `defaultvalueaddress_id` VARCHAR(64),
 `defaultvaluemeta_id` VARCHAR(64),
 `defaultvaluecontactdetail_id` VARCHAR(64),
 `defaultvaluecontributor_id` VARCHAR(64),
 `defaultvaluedosage_id` VARCHAR(64),
 `defaultvaluerelatedartifact_id` VARCHAR(64),
 `defaultvalueusagecontext_id` VARCHAR(64),
 `defaultvaluedatarequirement_id` VARCHAR(64),
 `defaultvaluetriggerdefinition_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `healthcareservice` (
 ...
 `location_id` VARCHAR(64),
 `coveragearea_id` VARCHAR(64),
 `availabletime_id` VARCHAR(64),
 `notavailable_id` VARCHAR(64),
 `endpoint_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
...
CREATE TABLE `immunization` (
 ...
 `status` VARCHAR(64),
 `notGiven` BOOLEAN,
 `vaccineCode` MEDIUMTEXT NOT NULL,
 `date` VARCHAR(1024),
 ...
 `dosequantity_id` VARCHAR(64),
 `practitioner_id` VARCHAR(64),
 `explanation_id` VARCHAR(64),
 `reaction_id` VARCHAR(64),
 `vaccinationprotocol_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `detectedissue` (
 ...
 `patient_id` VARCHAR(64),
 `author_id` VARCHAR(64),
 `implicated_id` VARCHAR(64),
 `mitigation_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `endpoint` (
 ...
 `identifier` MEDIUMTEXT,
 `status` VARCHAR(64),
 `connectionType` MEDIUMTEXT NOT NULL,
 `name` VARCHAR(1024),
 `contact` MEDIUMTEXT,
 `period` MEDIUMTEXT,
 `payloadType` MEDIUMTEXT NOT NULL,
...
CREATE TABLE `devicecomponent` (
 ...
 `source_id` VARCHAR(64),
 `parent_id` VARCHAR(64),
 `productionspecification_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `eligibilityresponsefinancial` (
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `allowedmoney_id` VARCHAR(64),
 `usedmoney_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `goal` (
 ...
 `addresses_id` VARCHAR(64),
 `outcomereference_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `questionnaireitem` (
 ...
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `enablewhen_id` VARCHAR(64),
 `options_id` VARCHAR(64),
 `option_id` VARCHAR(64),
 `initialquantity_id` VARCHAR(64),
...
CREATE TABLE `consent` (
 ...
 `language` VARCHAR(1024),
 `patient_id` VARCHAR(64),
 `consentingparty_id` VARCHAR(64),
 `actor_id` VARCHAR(64),
 `organization_id` VARCHAR(64),
 `sourcereference_id` VARCHAR(64),
 `policy_id` VARCHAR(64),
 `data_id` VARCHAR(64),
 `except_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `practitionerrole` (
 ...
 `organization_id` VARCHAR(64),
 `location_id` VARCHAR(64),
 `healthcareservice_id` VARCHAR(64),
 `availabletime_id` VARCHAR(64),
 `notavailable_id` VARCHAR(64),
 `endpoint_id` VARCHAR(64),
 `text_id` VARCHAR(64),
...
CREATE TABLE `measure` (
 ...
 `library_id` VARCHAR(64),
 `group_id` VARCHAR(64),
 `supplementaldata_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `immunizationrecommendationrecommendation` (
 ...
 `doseNumber` FLOAT,
 `forecastStatus` MEDIUMTEXT NOT NULL,
 `modifierExtension` MEDIUMTEXT,
 `id` VARCHAR(64) NOT NULL,
 `extension` MEDIUMTEXT,
 `parent_id` VARCHAR(64) NOT NULL,
 `datecriterion_id` VARCHAR(64),
 `protocol_id` VARCHAR(64),
 `supportingimmunization_id` VARCHAR(64),
 `supportingpatientinformation_id` VARCHAR(64),
 PRIMARY KEY (id)
);
--
...
CREATE TABLE `processresponse` (
 ...
 `requestorganization_id` VARCHAR(64),
 `processnote_id` VARCHAR(64),
 `communicationrequest_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
);
...
CREATE TABLE `taskoutput` (
 ...
 `valuequantity_id` VARCHAR(64),
 `valuesimplequantity_id` VARCHAR(64),
 `valuedistance_id` VARCHAR(64),
 `valuemoney_id` VARCHAR(64),
 `valuereference_id` VARCHAR(64),
 `valueaddress_id` VARCHAR(64),
...
CREATE TABLE `adverseevent` (
 ...
 `suspectentity_id` VARCHAR(64),
 `subjectmedicalhistory_id` VARCHAR(64),
 `referencedocument_id` VARCHAR(64),
 `study_id` VARCHAR(64),
 `text_id` VARCHAR(64),
 `meta_id` VARCHAR(64),
 PRIMARY KEY (id)
...
CREATE TABLE `plandefinitionaction` (
 ...
 `parent_id` VARCHAR(64) NOT NULL,
 `documentation_id` VARCHAR(64),
 `triggerdefinition_id` VARCHAR(64),
 `condition_id` VARCHAR(64),
 `input_id` VARCHAR(64),
 `output_id` VARCHAR(64),
 `relatedaction_id` VARCHAR(64),
